...
class Submenualphabridge extends Component
{
    /**
     * The Submenualphabridge title.
     *
     * @var string
     */
    public $title;
    ...
    /**
     * The Submenualphabridge device_id.
     *
     * @var string
     */
    public $device_id;
    ...
    {
        return view('components.submenualphabridge');
    }
}
