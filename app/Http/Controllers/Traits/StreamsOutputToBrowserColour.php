...
/**
 * StreamsOutputToBrowserColour.php
 *
 * -Description-
 *
...
use App\Logging\ApiColorFormatter;
...
trait StreamsOutputToBrowserColour
{
    ...
    {
        $formatter = $this->colour ? (new ApiColorFormatter()) : new NoColorFormatter();
