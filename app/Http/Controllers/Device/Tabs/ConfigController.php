...
class ConfigController extends Controller implements DeviceTab
{
    ...
    {
        return Gate::allows('config-backup.showConfig') && $this->manager->handles($device);
    }
    ...
    public function data(Device $device, Request $request): array
    {
        ...
        $empty = [
            ...
            'can_refresh' => $provider instanceof RefreshableConfigBackupProvider && Gate::allows('config-backup.refreshConfig'),
        ];
    ...
    {
        Gate::authorize('config-backup.showConfig');
    ...
    {
        Gate::authorize('config-backup.refreshConfig');
