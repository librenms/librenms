...
class ConfigController extends Controller implements DeviceTab
{
    ...
    {
        return Gate::allows('config-backup.show') && $this->manager->handles($device);
    }
    ...
    public function data(Device $device, Request $request): array
    {
        ...
        $empty = [
            ...
            'can_refresh' => $provider instanceof RefreshableConfigBackupProvider && Gate::allows('config-backup.refresh'),
        ];
    ...
    {
        Gate::authorize('config-backup.show');
    ...
    {
        Gate::authorize('config-backup.refresh');
