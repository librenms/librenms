    ...
    private function getSaps(Device $device): array
    {
        ...
        foreach ($saps as $sap) {
            ...
            $items[] = [
                ...
                'graph_vars' => ['device' => $device->device_id, 'page' => 'graphs', 'type' => 'device_sap', 'tab' => 'routing', 'proto' => 'mpls', 'view' => 'saps', 'traffic_id' => $sap->svc_oid . '.' . $sap->sapPortId . '.' . ($sap->sapEncapValue == '*' ? '4095' : $sap->sapEncapValue)],
                'type' => $sap->sapType,
