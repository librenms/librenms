...
class DynamicInputOption extends InputOption
{
    ...
    public function __construct(string $name, $shortcut = null, int $mode = null, string $description = '', $default = '', ?callable $defaultCallable = null, ?callable $descriptionCallable = null)
    {
