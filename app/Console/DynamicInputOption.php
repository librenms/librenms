...
class DynamicInputOption extends InputOption
{
    ...
    public function __construct(string $name, string|array|null $shortcut = null, ?int $mode = null, string $description = '', string|bool|int|float|array|null $default = null, ?callable $defaultCallable = null, ?callable $descriptionCallable = null, array|\Closure $suggestedValues = [])
    {
