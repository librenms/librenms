...
class SmokepingGenerateCommand extends LnmsCommand
{
    ...
    public function assembleProbes($probeCount)
    {
        ...
        return array_merge(
            $this->buildProbes('FPing', self::DEFAULTIP4PROBE, self::IP4PROBE, Config::getExecutable('fping'), $probeCount),
            $this->buildProbes('FPing6', self::DEFAULTIP6PROBE, self::IP6PROBE, Config::getExecutable('fping6'), $probeCount)
        );
    }
