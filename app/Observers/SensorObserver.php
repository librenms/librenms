...
class SensorObserver
{
     ...
     *
     * The old defaults were current - 10 for the low limit and current + 20
     * for the high limit, leaving a distinctive 30 degree gap. Only remove
     * that value when discovery no longer supplies a low limit. Explicit
     * hardware limits and user-customized limits are therefore preserved.
     */
