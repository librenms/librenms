...
class PortsNac extends BaseModel
{
    ...
    protected $fillable = [
        ...
        'PortAuthSessionAuthzStatus',
        'PortAuthSessionDomain',
        'PortAuthSessionHostMode',
        'PortAuthSessionUserName',
        'PortAuthSessionAuthzBy',
        'PortAuthSessionTimeOut',
        'PortAuthSessionTimeLeft',
        'PortAuthSessionAuthcStatus',
        'PortSessionMethod',
    ];
