...
update-subtrees: datetime-subtree moment-subtree font-awesome vis typeahead librenms-agent
...
librenms-agent:
	$(GIT_SUBTREE) --prefix=scripts/librenms-agent https://github.com/librenms/librenms-agent.git master
