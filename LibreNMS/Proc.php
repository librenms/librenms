...
class Proc
{
    ...
    {
        return array(stream_get_contents($this->_pipes[0]), stream_get_contents($this->_pipes[2]));
    }

    public function waitForOutput($timeout = 20)
    {
        stream_select($r = array($this->_pipes[0], $this->_pipes[2]), $w = null, $x = null, $timeout);
