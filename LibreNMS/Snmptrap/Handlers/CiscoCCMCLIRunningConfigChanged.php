...
class CiscoCCMCLIRunningConfigChanged implements SnmptrapHandler
{
    ...
    {
	    $EventID = explode('.', $trap->findOid('CISCO-CONFIG-MAN-MIB::ccmHistoryEventTerminalType'));
    	$ChangeTime =   $trap->getOidData($trap->findOid('CISCO-CONFIG-MAN-MIB::ccmHistoryRunningLastChanged.0'));
