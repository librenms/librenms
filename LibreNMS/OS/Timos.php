...
class Timos extends OS implements MplsDiscovery, MplsPolling, WirelessPowerDiscovery, WirelessSnrDiscovery, WirelessRsrqDiscovery, WirelessRssiDiscovery, WirelessRsrpDiscovery, WirelessChannelDiscovery
{
     ...
     * This overrides the generic poller to ensure correct RRD file creation.
     *
     * @return array
     */
    public function pollBgp(): array
    {
        ...
        $data = SnmpQuery::hideMib()->walk([
            ...
            return [
                ...
                'bgpPeerRemoteAddrType'     => $value[$mib . '.3.1.1'] ?? null, // Required for IPv4/IPv6 RRD file naming
        ...
        // Re-key the array by the remote IP address, which is required by the legacy poller
        $peers = [];
