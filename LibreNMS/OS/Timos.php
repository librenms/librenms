...
class Timos extends OS implements MplsDiscovery, MplsPolling, WirelessPowerDiscovery, WirelessSnrDiscovery, WirelessRsrqDiscovery, WirelessRssiDiscovery, WirelessRsrpDiscovery, WirelessChannelDiscovery
{
    ...
    public function discoverMplsSaps($svcs)
    {
        ...
        foreach ($mplsSapCache as $key => $value) {
            ...
            $saps->push(new MplsSap([
                ...
                'sapIngressBytes' => ($mplsSapTrafficCache[$traffic_id]['sapBaseStatsIngressPchipOfferedLoPrioOctets'] + $mplsSapTrafficCache[$traffic_id]['sapBaseStatsIngressPchipOfferedHiPrioOctets']) ?? null,
                'sapEgressBytes' => ($mplsSapTrafficCache[$traffic_id]['sapBaseStatsEgressQchipForwardedOutProfOctets'] + $mplsSapTrafficCache[$traffic_id]['sapBaseStatsEgressQchipForwardedInProfOctets']) ?? null,
                'sapIngressDroppedBytes' => ($mplsSapTrafficCache[$traffic_id]['sapBaseStatsIngressQchipDroppedLoPrioOctets'] + $mplsSapTrafficCache[$traffic_id]['sapBaseStatsIngressQchipDroppedHiPrioOctets']) ?? null,
                'sapEgressDroppedBytes' => ($mplsSapTrafficCache[$traffic_id]['sapBaseStatsEgressQchipDroppedOutProfOctets'] + $mplsSapTrafficCache[$traffic_id]['sapBaseStatsEgressQchipDroppedInProfOctets']) ?? null,
            ]));
        }
    ...
    public function pollMplsSaps($svcs)
    {
        ...
        foreach ($mplsSapCache as $key => $value) {
            ...
            $fields = [
                'sapIngressBits' => (($mplsSapTrafficCache[$traffic_id]['sapBaseStatsIngressPchipOfferedLoPrioOctets'] + $mplsSapTrafficCache[$traffic_id]['sapBaseStatsIngressPchipOfferedHiPrioOctets']) ?? 0) * 8,
                'sapEgressBits' => (($mplsSapTrafficCache[$traffic_id]['sapBaseStatsEgressQchipForwardedOutProfOctets'] + $mplsSapTrafficCache[$traffic_id]['sapBaseStatsEgressQchipForwardedInProfOctets']) ?? 0) * 8,
                'sapIngressDroppedBits' => (($mplsSapTrafficCache[$traffic_id]['sapBaseStatsIngressQchipDroppedLoPrioOctets'] + $mplsSapTrafficCache[$traffic_id]['sapBaseStatsIngressQchipDroppedHiPrioOctets']) ?? 0) * 8,
                'sapEgressDroppedBits' => (($mplsSapTrafficCache[$traffic_id]['sapBaseStatsEgressQchipDroppedOutProfOctets'] + $mplsSapTrafficCache[$traffic_id]['sapBaseStatsEgressQchipDroppedInProfOctets']) ?? 0) * 8,
            ];
