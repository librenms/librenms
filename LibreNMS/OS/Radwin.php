    ...
    WirelessRssiDiscovery
{
    ...
    public function discoverWirelessDistance()
    {
        ...
        return [
            new WirelessSensor(WirelessSensorType::Distance, $this->getDeviceId(), $oid, 'radwin', 0, 'Link distance', null, 1, 1000),
        ];
    }
    ...
    public function discoverWirelessPower()
    {
        ...
        return [
            new WirelessSensor(WirelessSensorType::Power, $this->getDeviceId(), $transmit, 'Radwin-Tx', 0, 'Tx Power'),
            new WirelessSensor(WirelessSensorType::Power, $this->getDeviceId(), $receive, 'Radwin-Rx', 0, 'Rx Power'),
        ];
    }
    ...
    public function discoverWirelessRssi()
    {
        ...
        return [
            new WirelessSensor(WirelessSensorType::Rssi, $this->getDeviceId(), $oid, 'radwin', 0, 'RSSI'),
        ];
    }
}
