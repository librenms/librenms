            ...
            switch ($rtt_type) {
                case 'jitter':
                    $jitter = [
                        ...
                        'PacketOutOfSequence' => $data[$sla_nr  ]['rttMonLatestJitterOperPacketOutOfSequence'] ?? null, // MIB not available on Cisco-NX OS
                        'PacketMIA' => $data[$sla_nr]['rttMonLatestJitterOperPacketMIA'] ?? null,                       // MIB not available on Cisco-NX OS
