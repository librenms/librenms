...
class Fortios extends Fortinet implements OSPolling
{
    ...
    public function pollOS()
    {
        ...
        if ($this->getDeviceModel()->features == 'with Analyzer features') {
            $log_rate = snmp_get($this->getDevice(), '.1.3.6.1.4.1.12356.103.2.1.9.0', '-Ovq');
            ...
            app()->make('Datastore')->put($this->getDevice(), 'fortios_lograte', $tags, $fields);
