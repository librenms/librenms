...
class RuckuswirelessAp extends OS implements
    ...
    WirelessErrorsDiscovery
{
    public function discoverWirelessClients()
    {
        ...
        return array(
            new WirelessSensor('clients', $this->getDeviceId(), $clients_2, 'ruckuswireless-ap', 1, 'Clients: 2.4G'),
            new WirelessSensor('clients', $this->getDeviceId(), $clients_5, 'ruckuswireless-ap', 2, 'Clients: 5G'),
        );
    }
    public function discoverWirelessUtilization()
    {
        ...
        return array(
            new WirelessSensor('utilization', $this->getDeviceId(), $utilization_2, 'ruckuswireless-ap', 1, 'Utilization: 2.4G'),
            new WirelessSensor('utilization', $this->getDeviceId(), $utelization_5, 'ruckuswireless-ap', 2, 'Utilization: 5G'),
        );
    }
    public function discoverWirelessNoiseFloor()
    {
        ...
        return array(
            new WirelessSensor('noise-floor', $this->getDeviceId(), $noise_floor_2, 'ruckuswireless-ap', 1, 'Noise-floor: 2.4G'),
            new WirelessSensor('noise-floor', $this->getDeviceId(), $noise_floor_5, 'ruckuswireless-ap', 2, 'Noise-floor: 5G'),
        );
    }
    public function discoverWirelessErrors()
    {
        ...
        return array(
            new WirelessSensor('errors', $this->getDeviceId(), $errors_2, 'ruckuswireless-ap', 1, 'Received errors: 2.4G'),
            new WirelessSensor('errors', $this->getDeviceId(), $errors_5, 'ruckuswireless-ap', 2, 'Received errors: 5G'),
        );
    }
}
