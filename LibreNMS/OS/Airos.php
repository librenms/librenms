    ...
    WirelessSignalDiscovery
{
    ...
    public function discoverWirelessFrequency()
    {
        ...
        return array(
            new WirelessSensor('frequency', $this->getDeviceId(), $oid, 'airos', 1, 'Radio Frequency', null, 1, 1000),
        );
    }
    ...
    public function discoverWirelessRate()
    {
        ...
        return array(
            new WirelessSensor('rate', $this->getDeviceId(), $tx_oid, 'airos-tx', 1, 'Tx Rate', null, 1, 1048576),
            new WirelessSensor('rate', $this->getDeviceId(), $rx_oid, 'airos-rx', 1, 'Rx Rate', null, 1, 1048576),
        );
    }
