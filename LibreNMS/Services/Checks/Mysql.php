...
class Mysql extends DefaultServiceCheck
{
    ...
    public function graphRrdCommands(string $rrd_filename, string $ds): string
    {
        ...
        if ($ds == 'mysqlqueries') {
            $graph = ' DEF:DS0=' . $rrd_filename . ':Queries:AVERAGE ';
            ...
            $graph .= ' DEF:DS1=' . $rrd_filename . ':Questions:AVERAGE ';
            ...
            $graph = ' DEF:DS0=' . $rrd_filename . ':Connections:AVERAGE ';
            ...
            $graph .= ' DEF:DS1=' . $rrd_filename . ':Open_files:AVERAGE ';
            $graph .= ' LINE1.25:DS1#' . $mixed_colours[3] . ":'" . str_pad(substr('Open_files', 0, 19), 19) . "' ";
            $graph .= ' GPRINT:DS1:LAST:%0.0lf ';
            $graph .= ' GPRINT:DS1:AVERAGE:%0.0lf ';
            $graph .= ' GPRINT:DS1:MAX:%0.0lf\\l ';
            $graph .= ' DEF:DS2=' . $rrd_filename . ':Open_tables:AVERAGE ';
            ...
            $graph .= ' DEF:DS3=' . $rrd_filename . ':Table_locks_waited:AVERAGE ';
            ...
            $graph .= ' DEF:DS4=' . $rrd_filename . ':Threads_connected:AVERAGE ';
            ...
            $graph .= ' DEF:DS5=' . $rrd_filename . ':Threads_running:AVERAGE ';
            ...
            $graph = ' DEF:DS0=' . $rrd_filename . ':Uptime:LAST ';
            ...
            $graph = ' DEF:DS0=' . $rrd_filename . ':Qcache_free_memory:AVERAGE ';
            ...
            $graph .= ' DEF:DS1=' . $rrd_filename . ':Qcache_hits:AVERAGE ';
            ...
            $graph .= ' DEF:DS2=' . $rrd_filename . ':Qcache_inserts:AVERAGE ';
            ...
            $graph .= ' DEF:DS3=' . $rrd_filename . ':Qcache_lowmem_prune:AVERAGE ';
            ...
            $graph .= ' DEF:DS4=' . $rrd_filename . ':Qcache_not_cached:AVERAGE ';
            ...
            $graph .= ' DEF:DS5=' . $rrd_filename . ':Qcache_queries_in_c:AVERAGE ';
