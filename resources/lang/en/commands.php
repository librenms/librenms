...
return [
    ...
    'smokeping:generate' => [
        ...
        'options' => [
            'no-probes' => 'Don\'t generate probe list - useful for splitting the smokeping configuration into multiple files',
            'no-targets' => 'Don\'t generate the target list - useful for splitting the smokeping configuration into multiple files',
            'no-header' => 'Don\'t add the boilerplate comment to the start of the generated file',
            'no-section-divider' => 'Don\'t include section dividers - useful for integrating LibreNMS with an existing smokeping setup',
            'no-default-probe' => 'Don\'t include a default probe - useful for integrating LibreNMS with an existing smokeping setup',
            'single-process' => 'Only use a single process for smokeping - useful for integrating LibreNMS with an existing smokeping setup',
        ],
    ],
