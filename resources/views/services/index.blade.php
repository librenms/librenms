    ...
    <div class="col-md-12">
      <ul class="nav nav-tabs">
        ...
        <li role="presentation" @if( $current_tab == 'ignored' ) class="active" @endif>
          <a href="{{ route('services.index') }}"><i class="fa fa-eyeslash fa-col-info fa-fw fa-lg fa-nav-icons hidden-md" aria-hidden="true"></i> @lang('Ignored')</a>
        </li>
        ...
        <li role="presentation" @if( $current_tab == 'maintenance' ) class="active" @endif>
          <a href="{{ route('services.index') }}"><i class="fa fa-calendar fa-col-danger fa-fw fa-lg fa-nav-icons hidden-md" aria-hidden="true"></i> @lang('Maintenance')</a>
        </li>
