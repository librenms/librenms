...
<head>
    ...
    @if(!LibreNMS\Config::get('favicon', false))
        <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('images/200x200.png') }}">
        <link rel="icon" type="image/png" href="{{ asset('images/200x200.png') }}" sizes="32x32">
        <link rel="icon" type="image/png" href="{{ asset('images/200x200.png') }}" sizes="16x16">
        <link rel="mask-icon" href="{{ asset('images/200x200.png') }}" color="#5bbad5">
        <link rel="shortcut icon" href="{{ asset('images/200x200.png') }}">
    @else
