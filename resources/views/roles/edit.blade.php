...
@section('content')
    <div class="tw:min-h-screen tw:bg-gradient-to-br tw:from-slate-50 tw:to-slate-100 tw:dark:from-zinc-950 tw:dark:to-zinc-900 tw:px-6 tw:py-8" x-data="roleForm({{ json_encode($role->permissions->pluck('name')) }})">
                ...
                <div class="tw:flex tw:items-center tw:gap-4">
                    ...
                    <div>
                        ...
                        <h1 class="tw:text-3xl tw:font-black tw:text-slate-800 tw:dark:text-zinc-100 tw:tracking-tight">
                            {{ __('permissions.rbac.edit_role') }}: <span class="tw:text-indigo-600 tw:dark:text-zinc-400">{{ $role->name }}</span>
                        </h1>
                    </div>
                </div>
