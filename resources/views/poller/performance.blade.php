...
<x-panel title="{{ __('Total Discovery Time') }}">
    <x-graph-row type="global_discovery_perf" columns="responsive" legend="yes"></x-graph-row>
</x-panel>

<x-panel title="{{ __('Total Discovery Time Per Module') }}">
    <x-graph-row type="global_discovery_modules_perf" columns="responsive" legend="yes"></x-graph-row>
</x-panel>
