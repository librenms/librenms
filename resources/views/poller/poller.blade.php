    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover table-condensed">
            ...
            <tr class="{{ $poller['row_class'] }}" id="row_{{ $poller['id'] }}">
                ...
                <td>{{ \LibreNMS\Util\Time::format(\LibreNMS\Util\Time::parse($poller['last_polled']), LibrenmsConfig::get('dateformat.compact')) }}</td>
        ...
        <table class="table table-striped table-bordered table-condensed">
            ...
            @foreach($poller_cluster as $poller)
                ...
                @if( $loop->first )
                    ...
                    <td rowspan="{{ $poller->stats->count() }}">{{ \LibreNMS\Util\Time::format(\LibreNMS\Util\Time::parse($poller->last_report), LibrenmsConfig::get('dateformat.compact')) }}</td>
