    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover table-condensed">
            ...
            <tr class="{{ $poller['row_class'] }}" id="row_{{ $poller['id'] }}">
                ...
                <td>{{ \LibreNMS\Util\Time::toUser(\LibreNMS\Util\Time::fromDb($poller['last_polled'])) }}</td>
        ...
        <table class="table table-striped table-bordered table-condensed">
            ...
            @foreach($poller_cluster as $poller)
                ...
                @if( $loop->first )
                    ...
                    <td rowspan="{{ $poller->stats->count() }}">{{ \LibreNMS\Util\Time::toUser(\LibreNMS\Util\Time::fromDb($poller->last_report)) }}</td>
