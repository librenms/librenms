     ...
     <table class="table table-hover table-condensed table-striped">
        <thead>
            <tr>
                ...
                <th><span class="--color-dark-gray-100">{{ __('Alert disabled') }}</span></th>
                <th><span class="--color-dark-gray-100">{{ __('Disabled') }}</span></th>
                @if($summary_errors)
                    <th class="--color-dark-gray-100">{{ __('Errored') }}</th>
                @endif
            </tr>
        </thead>
        <tbody>
            <tr>
                ...
                <td><a href="{{ url('devices/disable_notify=1/format=list_detail') }}"><span class="--color-dark-gray-100"> {{ $devices['disable_notify'] }}</span></a></td>
                <td><a href="{{ url('devices/disabled=1/format=list_detail') }}"><span class="--color-dark-gray-100"> {{ $devices['disabled'] }}</span></a></td>
                @if($summary_errors)
                    <td>-</td>
                @endif
            </tr>
            ...
            @if($show_services)
                <tr>
                    ...
                    <td><span class="--color-dark-gray-100"> -</span></td>
                    <td><a href="{{ url('services/disabled=1/view=details') }}"><span class="--color-dark-gray-100"> {{ $services['disabled'] }}</span></a></td>
                    @if($summary_errors)
                        <td><span class="--color-dark-gray-100"> -</span></td>
                    @endif
                </tr>
