...
@section('form')
    ...
    <div class="form-group">
        <label for="type-{{ $id }}" class="col-sm-4 control-label">@lang('Display type')</label>
        <div class="col-sm-8">
    ...
    <div class="form-group" id="color_only_select-group-{{ $id }}" style="display: {{ $type == 0 ? 'block' : 'none' }};">
        <label for="color_only_select-{{ $id }}" class="col-sm-4 control-label">@lang('Uniform Tiles')</label>
        <div class="col-sm-8">
    ...
    <div class="form-group" id="tile_size-group-{{ $id }}" style="display: {{ $type == 1 ? 'block' : 'none' }};">
        <label for="tile_size-{{ $id }}" class="col-sm-4 control-label">@lang('Tile size')</label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        <label for="show_disabled_and_ignored-{{ $id }}" class="col-sm-4 control-label">@lang('Disabled/ignored')</label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        <label for="mode_select-{{ $id }}" class="col-sm-4 control-label">@lang('Mode select')</label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        <label for="device_group-{{ $id }}" class="col-sm-4 control-label">@lang('Device group')</label>
        <div class="col-sm-8">
