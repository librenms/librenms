...
>
    ...
    <div x-cloak
          ...
          class="tw:hidden tw:absolute tw:bg-white! tw:dark:bg-dark-gray-300! tw:dark:text-white tw:border-2 tw:border-gray-200 tw:dark:border-dark-gray-200 tw:ml-3 tw:z-50 tw:font-normal tw:leading-normal tw:text-sm tw:text-left tw:no-underline tw:rounded-lg"
