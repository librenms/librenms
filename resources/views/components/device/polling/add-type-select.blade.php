<li class="tw:mt-4 tw:pt-2 tw:border-t tw:border-gray-200 tw:dark:border-dark-gray-400"
    ...
    <div class="input-group">
        <select id="add-method-select"
                class="form-control tw:rounded-l-lg tw:rounded-r-none tw:border-gray-200 tw:bg-white tw:dark:border-dark-gray-400 tw:dark:bg-dark-gray-500 tw:dark:text-white">
