@if(\LibreNMS\Config::get('title_image'))
    <img class="logon-logo img-responsive" src="{{ asset(\LibreNMS\Config::get('title_image')) }}">
@else
    <svg class="logon-logo img-responsive tw:dark:text-white tw:text-gray-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 170 32.275086">
        <defs>
            <clipPath id="a">
