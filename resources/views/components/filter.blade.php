        ...
        <div class="tw:relative tw:flex tw:items-stretch">
            <button type="button"
                ...
                <div class="tw:relative tw:flex tw:items-center">
                    <svg class="tw:w-[1.1em] tw:h-[1.1em]" viewBox="0 0 12 12" fill="none" stroke="currentColor"
                         stroke-width="2">
                ...
                <div class="tw:p-[1.5em] tw:space-y-[1.8em]">
                    ...
                    <div x-show="!nullary()">
                        ...
                        <template x-if="current?.endpoint">
                            <div @remote-selected.stop="
                                if (current.type === 'multi-select') {
                                    toggleMulti($event.detail.id, $event.detail.text);
                                } else {
                                    value = $event.detail.id;
                                    display = $event.detail.text;
                                    apply();
                                }
                            " :key="current.key">
                                <x-remote-dropdown
                                    ...
                                    ::multi="current.type === 'multi-select'"
                                />
                            </div>
                        </template>
