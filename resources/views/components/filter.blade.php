    ...
    <div class="tw:flex tw:items-stretch tw:h-[34px] tw:rounded-lg tw:border tw:border-neutral-300 tw:dark:border-dark-gray-300 tw:bg-white tw:dark:bg-dark-gray-500 tw:font-mono tw:shadow-xs tw:max-w-full">
            ...
            <template x-for="f in filters" :key="f.key">
                <div class="filter-chip tw:shrink-0 tw:relative tw:group tw:flex tw:items-stretch tw:h-full tw:border-r tw:border-neutral-200 tw:dark:border-dark-gray-300"
                    ...
                    <button type="button" title="{{ __('Edit filter') }}"
                            ...
                            class="tw:flex tw:items-center tw:h-full tw:px-4 tw:gap-2 tw:transition-colors tw:hover:bg-neutral-50 tw:dark:hover:bg-dark-gray-400 tw:whitespace-nowrap">
        ...
        <div class="tw:shrink-0 tw:relative tw:flex tw:items-stretch">
            ...
            <div x-show="showAdd" x-cloak x-transition @click.stop
                ...
                <div
                    class="tw:px-5 tw:py-2 tw:text-neutral-400 tw:dark:text-dark-white-400 tw:uppercase tw:tracking-wider">{{ __('Select Field') }}</div>
    ...
    <template x-teleport="body">
        <div x-show="dialog" x-cloak
            ...
            <div x-show="dialog" x-transition @click.stop
                ...
                {{-- Header --}}
                <div
                    class="tw:px-6 tw:py-[1.2em] tw:border-b tw:border-neutral-100 tw:dark:border-dark-gray-300 tw:bg-blue-50/20 tw:dark:bg-dark-gray-400 tw:flex tw:items-center tw:justify-between tw:rounded-t-2xl">
                    <div class="tw:text-[1.2em] tw:font-black tw:text-neutral-900! tw:dark:text-dark-white-100!">
                        <span x-text="current?.label"></span>
                        <span class="tw:ml-1 tw:text-base tw:text-[0.65em] tw:text-blue-600! tw:dark:text-blue-500! tw:uppercase">{{ __('Filter') }}</span>
                    </div>
