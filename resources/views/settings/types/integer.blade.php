<div class="form-group has-feedback {{ $class }}">
    ...
    <div class="col-sm-6 col-lg-4">
        <input id="{{ $name }}" class="form-control" onkeypress="return (event.charCode === 8 || event.charCode === 0) ? null : event.charCode >= 48 && event.charCode <= 57" type="text" name="{{ $name }}" value="{{ $value }}">
