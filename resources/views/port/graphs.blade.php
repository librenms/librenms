<div class="lnms-ports-graphs">
    <div class="lnms-ports-graphs__filters @if($hideFilter) tw:hidden @else tw:flex tw:justify-between @endif">
    ...
    <hr class="lnms-ports-graphs__rule tw:my-5 @if($hideFilter) tw:hidden @endif"/>

    <div class="lnms-ports-graphs__grid tw:grid tw:grid-cols-1 tw:md:grid-cols-2 tw:lg:grid-cols-4 tw:gap-4">
        @foreach($ports as $port)
            ...
            <div class="lnms-ports-graphs__item">
...
<x-slot name="footer">
    <div class="lnms-ports-footer tw:p-3 tw:flex tw:items-center tw:justify-between tw:flex-wrap tw:gap-4">
