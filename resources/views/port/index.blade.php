                    ...
                    <div class="btn-group pull-right" role="group">
                        <div class="btn-group" role="group" x-data="portPurge()">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                @if($view === 'graph')
                                    <li><a href="{{ $showGraphErrorsLink }}"><i class="fa fa-regular @if($showGraphErrors) fa-square-check @else fa-square @endif fa-lg fa-fw icon-theme" aria-hidden="true"></i> {{ __('port.show_graph_errors') }}</a></li>
                                @endif
