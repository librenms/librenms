<div class="lnms-devices-graphs">
    <div class="lnms-devices-graphs__filters @if($hideFilter) tw:hidden @else tw:flex tw:justify-between @endif">
    ...
    <hr class="lnms-devices-graphs__rule tw:my-5 @if($hideFilter) tw:hidden @endif"/>

    <div class="lnms-devices-graphs__grid tw:grid tw:grid-cols-1 tw:md:grid-cols-2 tw:lg:grid-cols-4 tw:gap-4">
        @foreach($deviceGraphs as $graph)
            <div class="lnms-devices-graphs__item">
...
<x-slot name="footer">
    <div class="lnms-devices-footer tw:p-3 tw:flex tw:items-center tw:justify-between tw:flex-wrap tw:gap-4">
