<x-option-bar name="{{ __('MPLS') }}" :options="$data['mpls_options']" :selected="$data['view']" />
                    ...
                    <tr>
                        ...
                        <td>
                            @if($item['destination_device'])
                                <x-device-link :device="$item['destination_device']" tab="routing" proto="mpls" view="lsp" />
                            @else
                                {{ $item['to_addr'] }}
                            @endif
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($item['fail_node_device'])
                                <x-device-link :device="$item['fail_node_device']" tab="routing" proto="mpls" />
                            @else
                                {{ $item['fail_node_addr'] ?: '-' }}
                            @endif
                        </td>
            ...
            <table class="table table-hover table-condensed table-striped">
                ...
                @forelse($data['items'] as $item)
                    <tr>
                        ...
                        <td>
                            @if($item['destination_device'])
                                <x-device-link :device="$item['destination_device']" tab="routing" proto="mpls" view="sdps" />
                            @else
                                {{ $item['far_end_addr'] }}
                            @endif
                        </td>
