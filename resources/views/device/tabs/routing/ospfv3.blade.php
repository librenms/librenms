...
@section('content')
    <x-device.page :device="$device" :subtitle="__('OSPFv3')">
        <x-device.routing-tabs :device="$device" tab="ospfv3" />
                                                ...
                                                <table class="table table-striped table-hover table-condensed">
                                                    ...
                                                    @forelse($instance['nbrs'] as $nbr)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @if($nbr['device_id'])
                                                                    <x-device-link :device="$nbr['device_id']" tab="routing" section="ospfv3" />
                                                                @else
