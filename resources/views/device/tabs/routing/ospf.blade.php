...
@section('content')
    <x-device.page :device="$device" :subtitle="__('OSPF')">
        <x-device.routing-tabs :device="$device" tab="ospf" />
                                                ...
                                                <table class="table table-striped table-hover table-condensed">
                                                    ...
                                                    @forelse($inst['nbrs'] as $nbr)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @if($nbr['device_id'])
                                                                    <x-device-link :device="$nbr['device_id']" tab="routing" section="ospf" />
                                                                @else
