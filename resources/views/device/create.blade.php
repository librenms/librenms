    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <form name="form1" method="post" action="" class="form-horizontal" role="form">
                ...
                <div class="alert alert-info">Devices will be checked for Ping/SNMP reachability before being probed.
                </div>
                <div class="well well-lg">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="hostname" name="hostname" class="form-control input-sm"
                                   placeholder="Hostname" value="{{old("hostname")}}">
                        </div>
                    </div>
                    <div class='form-group'>
                        <label for='hardware' class='col-sm-3 control-label'>SNMP</label>
                        <div class='col-sm-4'>
                            <input type="checkbox" id="snmp" name="snmp" data-size="small" onChange="disableSnmp(this);"
                                   checked>
                        </div>
                    </div>
                        ...
                        <div class='form-group'>
                            ...
                            <div class='col-sm-9'>
                                <input id='sysName' class='form-control' name='sysName'
                                       placeholder="sysName (optional)"/>
                            </div>
                        </div>
                        <div class='form-group'>
                            <label for='hardware' class='col-sm-3 control-label'>Hardware (optional)</label>
                            <div class='col-sm-9'>
                                <input id='hardware' class='form-control' name='hardware'
                                       placeholder="Hardware (optional)"/>
                            </div>
                        </div>
                        <div class='form-group'>
                    ...
                    <div id="snmp_conf" style="display: block;">
                        ...
                        <div class="form-group">
                            <label for="port_association_mode" class="col-sm-3 control-label">Port Association
                                Mode</label>
                            <div class="col-sm-3">
                                <select name="port_assoc_mode" id="port_assoc_mode" class="form-control input-sm">
                                    ...
                                    @foreach ($modes as $mode)
                                        ...
                                        <option value="{{$mode}}"
                                                @if($mode == $defaultMode) selected @endif>{{$mode}}</option>;
                        ...
                        <div id="snmpv1_2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="community" id="community" placeholder="Community"
                        ...
                        <div id="snmpv3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="authpass" id="authpass" placeholder="AuthPass"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="cryptopass" id="cryptopass" placeholder="Crypto Password"
                                           class="form-control input-sm" autocomplete="off">
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    @endif
                    <div class="form-group">
                        <label for="force_add" class="col-sm-3 control-label">Force add<br><small>(No ICMP or SNMP
                                checks performed)</small></label>
                        <div class="col-sm-9">
                    ...
                    <hr>
                    <center>
                        <button type="submit" class="btn btn-default" name="Submit">Add Device</button>
                    </center>
                </div>
            </form>
        </div>
