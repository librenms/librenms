        ...
        @foreach($unconfiguredMethods as $method)
            <div x-show="methodType === '{{ $method['type'] }}'" style="display: none;" x-transition
                ...
                @if(empty($method['schema_fields']))
                    ...
                    <div class="tw:mb-6 tw:p-4 tw:rounded-lg tw:border tw:border-gray-200 tw:dark:border-dark-gray-400 tw:max-w-2xl tw:bg-gray-50 tw:dark:bg-transparent">
                        <div class="tw:flex tw:items-start tw:gap-3">
                            <i class="fa fa-info-circle tw:text-blue-500 tw:mt-0.5 tw:shrink-0"></i>
                            <div>
                ...
                @else
                    ...
                    <div class="tw:mb-6 tw:p-4 tw:rounded-lg tw:border tw:border-gray-200 tw:dark:border-dark-gray-400 tw:max-w-2xl">
                        ...
                        <div class="tw:flex tw:gap-6">
                            <label class="tw:flex tw:items-center tw:cursor-pointer tw:group">
                                ...
                                <span class="tw:group-hover:text-blue-600 tw:transition-colors tw:text-gray-700 tw:dark:text-dark-white-200">{{ __('Use Existing Secret') }}</span>
                            </label>
                            <label class="tw:flex tw:items-center tw:cursor-pointer tw:group">
                    ...
                    <div x-show="credentialMode === 'existing'" style="display: none;" x-transition class="tw:mb-6 tw:max-w-2xl">
                    ...
                    {{-- New secret form --}}
                    <div x-show="credentialMode === 'new'" style="display: none;" x-transition class="tw:mb-6">
                        <div class="tw:mb-5 tw:max-w-2xl">
                        ...
                        <div class="tw:mb-6" x-data="{ isDefault: {{ old('default') ? 'true' : 'false' }} }">
                            <label class="tw:flex tw:items-center tw:cursor-pointer tw:group tw:px-4 tw:py-3 tw:rounded-lg tw:border tw:border-gray-200 tw:dark:border-dark-gray-400 tw:w-auto tw:max-w-2xl">
                        ...
                        <div class="tw:p-5 tw:rounded-lg tw:border tw:border-gray-200 tw:dark:border-dark-gray-400 tw:max-w-2xl"
                             x-data='{ formData: @json($method["schema_defaults"]) }'>
                            <h4 class="tw:font-medium tw:text-lg tw:mb-4 tw:border-b tw:pb-2 tw:border-gray-200 tw:dark:border-dark-gray-400 tw:text-gray-800 tw:dark:text-dark-white-100">
                ...
                @if(!empty($method['settings_fields']))
                    <div class="tw:mb-6 tw:p-5 tw:rounded-lg tw:border tw:border-gray-200 tw:dark:border-dark-gray-400 tw:max-w-2xl">
                        <h4 class="tw:font-medium tw:text-lg tw:mb-4 tw:border-b tw:pb-2 tw:border-gray-200 tw:dark:border-dark-gray-400 tw:text-gray-800 tw:dark:text-dark-white-100">
                            {{ $method['label'] }} {{ __('Configuration') }}
                        </h4>
