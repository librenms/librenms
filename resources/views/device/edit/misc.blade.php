    ...
    <x-device.page :device="$device">
        ...
        <form action="{{ route('device.edit.misc.update', $device->device_id) }}" method="POST" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="checkbox" name="override_icmp_disable" id="override_icmp_disable" data-size="small" {{ $device->getAttrib('override_icmp_disable') == 'true' ? 'checked' : '' }}>
                </div>
            </div>
            <div class="form-group">
                <label for="override_Oxidized_disable" class="col-sm-4 control-label">Exclude from Oxidized?</label>
                <div class="col-sm-8">
                    <input type="checkbox" name="override_Oxidized_disable" id="override_Oxidized_disable" data-size="small" {{ $device->getAttrib('override_Oxidized_disable') == 'true' ? 'checked' : '' }}>
                </div>
            </div>
            <div class="form-group @error('override_device_ssh_port') has-error @enderror">
                ...
                <div class="col-sm-8">
                    <input type="text" name="override_device_ssh_port" id="override_device_ssh_port" class="form-control" value="{{ old('override_device_ssh_port', $device->getAttrib('override_device_ssh_port')) }}">
            ...
            <div class="form-group @error('override_device_telnet_port') has-error @enderror">
                ...
                <div class="col-sm-8">
                    <input type="text" name="override_device_telnet_port" id="override_device_telnet_port" class="form-control" value="{{ old('override_device_telnet_port', $device->getAttrib('override_device_telnet_port')) }}">
            ...
            <div class="form-group @error('override_device_http_port') has-error @enderror">
                ...
                <div class="col-sm-8">
                    <input type="text" name="override_device_http_port" id="override_device_http_port" class="form-control" value="{{ old('override_device_http_port', $device->getAttrib('override_device_http_port')) }}">
            ...
            <div class="form-group @error('override_Unixagent_port') has-error @enderror">
                ...
                <div class="col-sm-8">
                    <input type="text" name="override_Unixagent_port" id="override_Unixagent_port" class="form-control" value="{{ old('override_Unixagent_port', $device->getAttrib('override_Unixagent_port')) }}">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="checkbox" name="override_rrdtool_tune" id="override_rrdtool_tune" data-size="small" {{ $device->getAttrib('override_rrdtool_tune') == 'true' ? 'checked' : '' }}>
                </div>
            </div>
            <div class="form-group">
                <label for="selected_ports" class="col-sm-4 control-label">Enable selected port polling?</label>
                <div class="col-sm-8">
                    <input type="checkbox" name="selected_ports" id="selected_ports" data-size="small" {{ $device->getAttrib('selected_ports') == 'true' ? 'checked' : '' }}>
                </div>
            </div>
            <div class="form-group">
