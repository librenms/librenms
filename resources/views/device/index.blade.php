...
@section('content')
    <div class="container-fluid lnms-devices">
        <x-panel class="lnms-devices-panel">
            <x-slot name="heading">
                <div class="lnms-devices-toolbar tw:flex tw:justify-between tw:flex-wrap tw:gap-2">
                    <div class="lnms-devices-nav tw:min-h-8">
                    ...
                    <div class="btn-group pull-right lnms-devices-menu" role="group">
