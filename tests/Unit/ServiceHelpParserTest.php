...
EOF,
                [
                    (new CheckParameter('--warning', '-w', 'PERCENT%', 'Exit with WARNING status if less than PERCENT of disk space is free'))->setRequired(),
                    (new CheckParameter('--critical', '-c', 'PERCENT%', 'Exit with CRITICAL status if less than PERCENT of disk space is free'))->setRequired(),
                    new CheckParameter('--iwarning', '-W', 'PERCENT%', 'Exit with WARNING status if less than PERCENT of inode space is free'),
                    new CheckParameter('--icritical', '-K', 'PERCENT%', 'Exit with CRITICAL status if less than PERCENT of inode space is free'),
                    new CheckParameter('--group', '-g', 'NAME', 'Group paths. Thresholds apply to (free-)space of all partitions together'),
                    new CheckParameter('--eregi-path', '-R', 'PATH', 'Case insensitive regular expression for path/partition (may be repeated)'),
                    new CheckParameter('--ereg-path', '-r', 'PATH', 'Regular expression for path or partition (may be repeated)'),
                    new CheckParameter('--timeout', '-t', 'INTEGER', 'Seconds before plugin times out (default: 10)'),
                    new CheckParameter('--units', '-u', 'STRING', 'Choose bytes, kB, MB, GB, TB (default: MB)'),
                    new CheckParameter('--exclude-type', '-X', 'TYPE', 'Ignore all filesystems of indicated type (may be repeated)'),
                    new CheckParameter('--include-type', '-N', 'TYPE', 'Check only filesystems of indicated type (may be repeated)'),
                    ...
                    new CheckParameter('--path', '-p', 'PATH', 'Mount point or block device as emitted by the mount(8) command (may be repeated)'),
                    new CheckParameter('--exclude_device', '-x', 'PATH <STRING>', 'Ignore device (only works if -p unspecified)'),
                    new CheckParameter('--clear', '-C', '', 'Clear thresholds'),
                    new CheckParameter('--exact-match', '-E', '', 'For paths or partitions specified with -p, only check for exact paths'),
                    new CheckParameter('--errors-only', '-e', '', 'Display only devices/mountpoints with errors'),
                    new CheckParameter('--freespace-ignore-reserved', '-f', '', 'Don\'t account root-reserved blocks into freespace in perfdata'),
                    new CheckParameter('--iperfdata', '-P', '', 'Display inode usage in perfdata'),
                    new CheckParameter('--kilobytes', '-k', '', 'Same as \'--units kB\''),
                    new CheckParameter('--local', '-l', '', 'Only check local filesystems'),
                    new CheckParameter('--stat-remote-fs', '-L', '', "Only check local filesystems against thresholds. Yet call stat on remote filesystems\nto test if they are accessible (e.g. to detect Stale NFS Handles)"),
                    new CheckParameter('--mountpoint', '-M', '', 'Display the mountpoint instead of the partition'),
                    new CheckParameter('--megabytes', '-m', '', 'Same as \'--units MB\''),
                    new CheckParameter('--all', '-A', '', 'Explicitly select all paths. This is equivalent to -R \'.*\''),
                    new CheckParameter('--ignore-eregi-path', '-I', 'PATH', 'Regular expression to ignore selected path/partition (case insensitive) (may be repeated)'),
                    new CheckParameter('--ignore-ereg-path', '-i', 'PATH', 'Regular expression to ignore selected path or partition (may be repeated)'),
