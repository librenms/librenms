...
class ComponentTest extends DBTestCase
{
    ...
    {
        Component::factory()->create(['device_id' => 1, 'ignore' => 1]);
        $target = Component::factory()->times(2)->create(['device_id' => 1, 'ignore' => 0]);
        $component = new Component();
    ...
    {
        Component::factory()->create(['label' => 'Search Phrase']);
        Component::factory()->times(2)->create(['label' => 'Something Else']);
        $target = Component::factory()->times(2)->create(['label' => 'Search Phrase']);
        Component::factory()->create(['label' => 'Search Phrase']);
        $component = new Component();
    ...
    {
        Component::factory()->times(2)->create(['device_id' => 1, 'type' => 'three']);
        Component::factory()->create(['device_id' => 2, 'type' => 'three']);
        Component::factory()->create(['device_id' => 2, 'type' => 'one']);
    ...
    public function testGetComponentStatusLog()
    {
        ...
        $model = Component::factory()->create();
