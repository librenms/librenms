...
class MgmtTrapNmsAlarmTest extends SnmpTrapTestCase
{
    public function testAlarmClear() {
        ...
        $trapText = "$device->hostname UDP: [$device->ip]:60057->[192.168.1.100]:162
        ...
        EKINOPS-MGNT2-NMS-MIB::mgnt2AlmLogSourcePm PM_20020-MA
        EKINOPS-MGNT2-NMS-MIB::mgnt2AlmLogBoardNumber 16
        ...
        EKINOPS-MGNT2-NMS-MIB::mgnt2AlmLogSpecificProblem Module Failure
        ...
        $msg = "Alarm on slot 16, PM_20020-MA. Issue: Module Failure. Possible Cause: Unknown";
