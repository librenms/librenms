...
SNMPv2-MIB::sysUpTime.0 = Timeticks: Timeticks: (2940) 0:00:29.40
SNMPv2-MIB::snmpTrapOID.0 AXIS-VIDEO-MIB::alarmNew
AXIS-VIDEO-MIB::alarmID = Gauge32: 1
AXIS-VIDEO-MIB::alarmName = STRING: Edge Storage Operation
AXIS-VIDEO-MIB::alarmText = STRING: Check the SD_DISK storage device',
            'Axis Alarm Trap: Alarm ID $AlarmID: $AlarmName: $Message',
...
AXIS-VIDEO-MIB::alarmID = Gauge32: 2
AXIS-VIDEO-MIB::alarmName = STRING: Fan Operation
AXIS-VIDEO-MIB::alarmText = STRING: Check the fan',
...
AXIS-VIDEO-MIB::alarmID = Gauge32: 3
AXIS-VIDEO-MIB::alarmName = STRING: Camera Tampering
AXIS-VIDEO-MIB::alarmText = STRING: Check if the camera is blocked, redirected or defocused',
