...
class RrdDefinitonTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $expected = 'DS:bad_name_is_too_lon:GAUGE:600:0:100 ';
        $def = RrdDefinition::make()->addDataset('b a%d$_n:a^me_is_too_lon%g.', 'GAUGE', 0, 100, 600);
