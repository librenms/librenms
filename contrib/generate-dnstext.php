...
$sql = "SELECT * FROM ipv4_addresses AS A, ports as I, devices as D WHERE A.port_id = I.port_id AND I.device_id = D.device_id AND D.os = 'ios'";
foreach (dbFetchRows($sql) as $ip)
{
  unset($sub);
