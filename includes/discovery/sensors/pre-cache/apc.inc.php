...
$pre_cache['apcups_phase_count'] = SnmpQuery::get('PowerNet-MIB::upsPhaseNumInputPhases.1')->value();
...
$pre_cache['memSensorsStatusSysTempUnits'] = SnmpQuery::get('PowerNet-MIB::memSensorsStatusSysTempUnits.0')->value();
