...
foreach (explode("\n", (string) $oids) as $data) {
    ...
    if ($data) {
        ...
        discover_sensor(null, \LibreNMS\Enum\Sensor::FREQUENCY, $device, $oid, "3.2.1.4.$index", $type, $descr, $divisor, '1', null, null, null, null, $current);
    }
}
...
foreach (explode("\n", (string) $oids) as $data) {
    ...
    if ($data) {
        ...
        discover_sensor(null, \LibreNMS\Enum\Sensor::FREQUENCY, $device, $oid, "4.2.1.4.$index", $type, $descr, $divisor, '1', null, null, null, null, $current);
    }
}
...
if ($oids) {
    ...
    $type = 'apc';
    $descr = 'Input';
    discover_sensor(null, \LibreNMS\Enum\Sensor::FREQUENCY, $device, $oid, $index, $type, $descr, $divisor, '1', null, null, null, null, $current / $divisor);
}
