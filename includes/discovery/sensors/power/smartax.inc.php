...
discover_sensor(null, \LibreNMS\Enum\Sensor::POWER, $device, $power_frame_oid, $index, 'smartax-total', 'Chassis Total', '1', '1', null, null, null, null, $power);
...
foreach ($data as $index => $value) {
    ...
    discover_sensor(null, \LibreNMS\Enum\Sensor::POWER, $device, $pow_oid, $index, 'smartax', $descr, '1', '1', null, null, null, null, $powerCurr);
}
