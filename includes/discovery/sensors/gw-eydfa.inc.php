...
foreach (explode("\n", (string) $oids) as $data) {
    ...
    if ($split_oid[0] == 'oaPumpBIAS') { // Current - mA
        ...
        discover_sensor(null, \LibreNMS\Enum\Sensor::CURRENT, $device, $num_oid, $sensor_index, 'gw-eydfa', $descr, $divisor, 1, $low_limit, $low_warn, $high_warn, $high_limit, $value);
    }
    ...
    if ($split_oid[0] == 'oaPumpTemp' && $index == 1) { // Temperature - C
        ...
        discover_sensor(null, \LibreNMS\Enum\Sensor::TEMPERATURE, $device, $num_oid, $sensor_index, 'gw-eydfa', $descr, $divisor, 1, $low_limit, $low_warn, $high_warn, $high_limit, $value);
    }
...
foreach (explode("\n", $oids) as $data) {
    ...
    if ($split_oid[0] == 'oaDCPowerVoltage') { // Voltage - V
        ...
        $value /= $divisor;
        discover_sensor(null, \LibreNMS\Enum\Sensor::VOLTAGE, $device, $num_oid, $sensor_index, 'gw-eydfa', $descr, $divisor, 1, $low_limit, $low_warn, $high_warn, $high_limit, $value);
    }
}
...
discover_sensor(null, \LibreNMS\Enum\Sensor::TEMPERATURE, $device, $num_oid, $sensor_index, 'gw-eydfa', $descr, 1, 1, $low_limit, $low_warn, $high_warn, $high_limit, $value);
...
discover_sensor(null, \LibreNMS\Enum\Sensor::DBM, $device, $num_oid, $sensor_index, 'gw-eydfa', $descr, $divisor, 1, $low_limit, $low_warn, $high_warn, $high_limit, $value);
...
foreach ($oids as $oid) {
    ...
    discover_sensor(null, \LibreNMS\Enum\Sensor::STATE, $device, $oid, $sensor_index, $state_name, $descr, 1, 1, null, null, null, null, $value, 'snmp');
    $n++;
}
