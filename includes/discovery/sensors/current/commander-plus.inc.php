...
$divisor = 1;
$multiplier = 1;
discover_sensor(null, \LibreNMS\Enum\Sensor::CURRENT, $device, $oid, 'batteryCurrent', 'commander-plus', $descr, $divisor, $multiplier, null, null, null, null, $current);
...
$limit_low = 0;
$limit = 5000;
discover_sensor(null, \LibreNMS\Enum\Sensor::CURRENT, $device, $oid, 'rectifierLoadCurrent', 'commander-plus', $descr, $divisor, $multiplier, $limit_low, null, null, $limit, $current);
