...
echo 'Schleifenbauer ';
$divisor = 100;
if (isset($pre_cache['sdbMgmtCtrlDevUnitAddress']) && is_array($pre_cache['sdbMgmtCtrlDevUnitAddress'])) {
...
if (isset($pre_cache['sdbDevOutMtActualCurrent']) && is_array($pre_cache['sdbDevOutMtActualCurrent'])) {
