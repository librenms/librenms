...
$tmp_eltex = snmp_get($device, 'eltMesIssEnvFanTable eltMesIssEnvFanEntry eltMesIssEnvFanSpeed eltMesIssEnvFanSpeedLevel eltMesIssEnvFanThresholdTable eltMesIssEnvFanThresholdEntry eltMesIssEnvFanThresholdLevel eltMesIssEnvFanThresholdMin eltMesIssEnvFanThresholdMax', '-OUQn', 'ELTEX-MES-ISS-ENV-MIB');
