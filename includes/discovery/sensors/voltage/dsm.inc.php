...
if (is_numeric($ups_input_voltage)) {
    discover_sensor(null, \LibreNMS\Enum\Sensor::VOLTAGE, $device, $ups_input_voltage_oid, 'UPSInputVoltageValue', $ups_device_manufacturer . ' ' . $ups_device_model, 'UPS Input Voltage Value', '1', '1', null, null, null, null, $ups_input_voltage);
}
...
if (is_numeric($ups_input_voltage_nominal)) {
    discover_sensor(null, \LibreNMS\Enum\Sensor::VOLTAGE, $device, $ups_input_voltage_nominal_oid, 'UPSInputVoltageNominal', $ups_device_manufacturer . ' ' . $ups_device_model, 'UPS Input Voltage Nominal', '1', '1', null, null, null, null, $ups_input_voltage_nominal);
}
...
if (is_numeric($ups_battery_voltage)) {
    discover_sensor(null, \LibreNMS\Enum\Sensor::VOLTAGE, $device, $ups_battery_voltage_oid, 'UPSBatteryVoltage', $ups_device_manufacturer . ' ' . $ups_device_model, 'UPS Battery Voltage', '1', '1', null, null, null, null, $ups_battery_voltage);
}
...
if (is_numeric($ups_battery_voltage_nominal)) {
    discover_sensor(null, \LibreNMS\Enum\Sensor::VOLTAGE, $device, $ups_battery_voltage_nominal_oid, 'SystemStatus', $ups_device_manufacturer . ' ' . $ups_device_model, 'UPS Battery Voltage Nominal', '1', '1', null, null, null, null, $ups_battery_voltage_nominal);
}
