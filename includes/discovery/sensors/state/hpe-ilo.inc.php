...
$tables = array(
    ...
    array('cpqSeCpuStatus','.1.3.6.1.4.1.232.1.2.2.1.1.6.','cpqSeCpuStatus','CPUStatus','CPQSTDEQ-MIB'),
...
*/
            ...
            } elseif ($state_name == 'cpqHeFltTolPowerSupplyCondition' || $state_name == 'cpqHeFltTolFanCondition' || $state_name == 'cpqSeCpuStatus') {
                $states = array(
                    array($state_index_id,'other',1,1,3),
                    array($state_index_id,'ok',1,2,0),
        ...
        foreach ($temp as $index => $entry) {
            ...
            } elseif ($state_name == 'cpqSeCpuStatus') {
                 $descr = 'Processor #'.trim(snmp_get($device, ".1.3.6.1.4.1.232.1.2.2.1.1.2.$index", "-Ovqn"), '"') . ' ' .trim(snmp_get($device, ".1.3.6.1.4.1.232.1.2.2.1.1.3.$index", "-Ovqn"), '"');
            } elseif ($state_name == 'cpqHeResMem2ModuleCondition') {
