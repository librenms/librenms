...
if (is_numeric($power1)) {
    ...
    $descr = 'Power 1 State';
    discover_sensor(null, \LibreNMS\Enum\Sensor::STATE, $device, $oid_power1, $index, $state_name, $descr, 1, 1, null, null, null, null, $power1, 'snmp', $index);
}
...
if (is_numeric($power2)) {
    ...
    $descr = 'Power 2 State';
    discover_sensor(null, \LibreNMS\Enum\Sensor::STATE, $device, $oid_power2, $index, $state_name, $descr, 1, 1, null, null, null, null, $power2, 'snmp', $index);
}
...
if (is_numeric($fan)) {
    ...
    $descr = 'Fan State';
    discover_sensor(null, \LibreNMS\Enum\Sensor::STATE, $device, $oid_fan, $index, $state_name, $descr, 1, 1, null, null, null, null, $fan, 'snmp', $index);
}
