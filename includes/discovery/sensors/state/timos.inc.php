...
function states_from_array($array) {
...
if ($device['os'] === 'timos') {
  ...
  $nokia_device_state_name  = 'tmnxDeviceState01';
  ...
  if ($nokia_device_state_index !== null) {
    ...
    states_from_array($nokia_device_states);
  }
  ...
  if ($nokia_device_ps_assigned_types_index !== null) {
    ...
    states_from_array($nokia_device_ps_assigned_types);
  }
