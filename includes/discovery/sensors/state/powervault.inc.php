...
if (is_numeric($value)) {
    ...
    $states = array(
        array('value' => 1, 'generic' => 0, 'graph' => 2, 'descr' => 'other'),
        array('value' => 2, 'generic' => 0, 'graph' => 3, 'descr' => 'unknown'),
        array('value' => 3, 'generic' => 0, 'graph' => 0, 'descr' => 'ok'),
        array('value' => 4, 'generic' => 0, 'graph' => 2, 'descr' => 'critical'),
        array('value' => 5, 'generic' => 0, 'graph' => 2, 'descr' => 'non-Recoverable'),
    );
