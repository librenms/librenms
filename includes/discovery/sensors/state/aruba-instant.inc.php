...
if (!empty($oids)) {
    ...
    foreach ($oids as $ap_index => $ap_entry) {
        ...
        discover_sensor($valid['sensor'], 'state', $device, $ap_state_oid, $ap_state_index, $ap_state_name, $ap_descr, '1', '1', null, null, null, null, $ap_entry[$ap_state_name], 'snmp', null, null, null, 'Cluster APs');
