...
foreach ($pre_cache['procurve_hpicfXcvrInfoTable'] as $index => $entry) {
    if (isset($entry['hpicfXcvrRxPower']) && is_numeric($entry['hpicfXcvrRxPower']) && $entry['hpicfXcvrRxPower'] != -99999999 && isset($entry['hpicfXcvrDiagnosticsUpdate'])) {
    ...
    if (isset($entry['hpicfXcvrTxPower']) && is_numeric($entry['hpicfXcvrTxPower']) && $entry['hpicfXcvrTxPower'] != -99999999 && isset($entry['hpicfXcvrDiagnosticsUpdate'])) {
