...
if (is_numeric($a1_tx)) {
    ...
    $multiplier = '1';
    discover_sensor(
        $valid['sensor'], 'dbm', $device, $oid_a1_tx, $index, 'fs-nmu', $descr, $divisor, $multiplier, null, null, null, null, $a1_tx, 'snmp'
    );
}
...
if (is_numeric($a1_rx)) {
    ...
    $multiplier = '1';
    discover_sensor(
        $valid['sensor'], 'dbm', $device, $oid_a1_rx, $index, 'fs-nmu', $descr, $divisor, $multiplier, null, null, null, null, $a1_rx, 'snmp'
    );
}
...
if (is_numeric($a2_tx)) {
    ...
    $multiplier = '1';
    discover_sensor(
        $valid['sensor'], 'dbm', $device, $oid_a2_tx, $index, 'fs-nmu', $descr, $divisor, $multiplier, null, null, null, null, $a2_tx, 'snmp'
    );
}
...
if (is_numeric($a2_rx)) {
    ...
    $multiplier = '1';
    discover_sensor(
        $valid['sensor'], 'dbm', $device, $oid_a2_rx, $index, 'fs-nmu', $descr, $divisor, $multiplier, null, null, null, null, $a2_rx, 'snmp'
    );
}
...
if (is_numeric($b1_tx)) {
    ...
    discover_sensor(
        $valid['sensor'], 'dbm', $device, $oid_b1_tx, $index, 'fs-nmu', $descr, $divisor, $multiplier, null, null, null, null, $b1_tx, 'snmp'
    );
}
...
if (is_numeric($b1_rx)) {
    ...
    $multiplier = '1';
    discover_sensor(
        $valid['sensor'], 'dbm', $device, $oid_b1_rx, $index, 'fs-nmu', $descr, $divisor, $multiplier, null, null, null, null, $b1_rx, 'snmp'
    );
}
...
if (is_numeric($b2_tx)) {
    ...
    $multiplier = '1';
    discover_sensor(
        $valid['sensor'], 'dbm', $device, $oid_b2_tx, $index, 'fs-nmu', $descr, $divisor, $multiplier, null, null, null, null, $b2_tx, 'snmp'
    );
}
...
if (is_numeric($b2_rx)) {
    ...
    $multiplier = '1';
    discover_sensor(
        $valid['sensor'], 'dbm', $device, $oid_b2_rx, $index, 'fs-nmu', $descr, $divisor, $multiplier, null, null, null, null, $b2_rx, 'snmp'
    );
}
...
if (is_numeric($c1_tx)) {
    ...
    $multiplier = '1';
    discover_sensor(
        $valid['sensor'], 'dbm', $device, $oid_c1_tx, $index, 'fs-nmu', $descr, $divisor, $multiplier, null, null, null, null, $c1_tx, 'snmp'
    );
}
...
if (is_numeric($c1_rx)) {
    ...
    $multiplier = '1';
    discover_sensor(
        $valid['sensor'], 'dbm', $device, $oid_c1_rx, $index, 'fs-nmu', $descr, $divisor, $multiplier, null, null, null, null, $c1_rx, 'snmp'
    );
}
...
if (is_numeric($c2_tx)) {
    ...
    $multiplier = '1';
    discover_sensor(
        $valid['sensor'], 'dbm', $device, $oid_c2_tx, $index, 'fs-nmu', $descr, $divisor, $multiplier, null, null, null, null, $c2_tx, 'snmp'
    );
}
...
if (is_numeric($c2_rx)) {
    ...
    $multiplier = '1';
    discover_sensor(
        $valid['sensor'], 'dbm', $device, $oid_c2_rx, $index, 'fs-nmu', $descr, $divisor, $multiplier, null, null, null, null, $c2_rx, 'snmp'
    );
}
...
if (is_numeric($d1_tx)) {
    ...
    discover_sensor(
        $valid['sensor'], 'dbm', $device, $oid_d1_tx, $index, 'fs-nmu', $descr, $divisor, $multiplier, null, null, null, null, $d1_tx, 'snmp'
    );
}
...
if (is_numeric($d1_rx)) {
    ...
    $multiplier = '1';
    discover_sensor(
        $valid['sensor'], 'dbm', $device, $oid_d1_rx, $index, 'fs-nmu', $descr, $divisor, $multiplier, null, null, null, null, $d1_rx, 'snmp'
    );
}
...
if (is_numeric($d2_tx)) {
    ...
    $multiplier = '1';
    discover_sensor(
        $valid['sensor'], 'dbm', $device, $oid_d2_tx, $index, 'fs-nmu', $descr, $divisor, $multiplier, null, null, null, null, $d2_tx, 'snmp'
    );
}
...
if (is_numeric($d2_rx)) {
    ...
    $multiplier = '1';
    discover_sensor(
        $valid['sensor'], 'dbm', $device, $oid_d2_rx, $index, 'fs-nmu', $descr, $divisor, $multiplier, null, null, null, null, $d2_rx, 'snmp'
    );
}
