...
foreach ($lib_data as $index => $data) {
    ...
    if (is_numeric($current)) {
        ...
        discover_sensor(null, \LibreNMS\Enum\Sensor::HUMIDITY, $device, $oid, $new_index, 'liebert', $descr, $divisor, 1, $low_limit, null, null, $high_limit, $current / $divisor);
    }
}
...
if (is_numeric($return_humidity)) {
    ...
    discover_sensor(null, \LibreNMS\Enum\Sensor::HUMIDITY, $device, $oid, $index, 'liebert', $descr, $divisor, '1', null, null, null, null, $return_humidity);
}
...
if (is_numeric($supply_humidity)) {
    ...
    discover_sensor(null, \LibreNMS\Enum\Sensor::HUMIDITY, $device, $oid, $index, 'liebert', $descr, $divisor, '1', null, null, null, null, $supply_humidity);
}
