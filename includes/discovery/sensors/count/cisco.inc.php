...
$tables = [
    ['num_oid' => '.1.3.6.1.4.1.9.9.661.1.3.1.1.1.',    'oid' => 'c3gImsi',                    'state_name' => 'c3gImsi',                    'mib' => 'CISCO-WAN-3G-MIB',      'descr' => 'IMSI'],
    ['num_oid' => '.1.3.6.1.4.1.9.9.661.1.3.1.1.2.',    'oid' => 'c3gImei',                    'state_name' => 'c3gImei',                    'mib' => 'CISCO-WAN-3G-MIB',       'descr' => 'IMEI'],
...
foreach ($tables as $tablevalue) {
    ...
    foreach ($temp as $index => $entry) {
        ...
        if ($state_name == 'c3gImsi' || $state_name == 'c3gImei' || $state_name == 'c3gIccId' || $state_name == 'c3gMsisdn' || $state_name == 'c3gGsmNumberOfNearbyCell' || $state_name == 'cwceLteCurrOperatingBand') {
