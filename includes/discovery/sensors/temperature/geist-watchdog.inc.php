...
if ($value) {
    ...
    $descr = 'Temperature';
    discover_sensor(null, \LibreNMS\Enum\Sensor::TEMPERATURE, $device, $current_oid, 'climateTempC', 'geist-watchdog', $descr, 1, 1, null, null, null, null, $value);
}
...
if ($value) {
    ...
    $descr = 'Temperature';
    discover_sensor(null, \LibreNMS\Enum\Sensor::TEMPERATURE, $device, $current_oid, 'climateTempF', 'geist-watchdog', $descr, 1, 1, null, null, null, null, $value, null, null, null, 'fahrenheit_to_celsius');
}
...
foreach ($temp_table as $index => $temp_data) {
    if ($temp_data['tempSensorAvail'] == 1) {
        ...
        discover_sensor(null, \LibreNMS\Enum\Sensor::TEMPERATURE, $device, $current_oid, $index, 'geist-watchdog', $descr, 1, 1, null, null, null, null, $value);
    }
}
