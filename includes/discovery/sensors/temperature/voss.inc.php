...
if (is_array($rcChasFan)) {
    foreach (array_keys($rcChasFan) as $index) {
        ...
        discover_sensor(null, \LibreNMS\Enum\Sensor::TEMPERATURE, $device, $oid, "$var1.$index", 'avaya-vsp', $descr, '1', '1', null, null, null, null, $value);
    }
}
...
if (is_numeric($value) && $value != 0) {
    discover_sensor(null, \LibreNMS\Enum\Sensor::TEMPERATURE, $device, $oid, $index, 'avaya-vsp', $descr, '1', '1', null, null, null, null, $value);
}
