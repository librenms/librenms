...
if (is_array($rcChasFan)) {
    foreach (array_keys($rcChasFan) as $index) {
        ...
        discover_sensor($valid['sensor'], 'temperature', $device, $oid, "$var1.$index", 'extreme-voss', $descr, '1', '1', null, null, null, null, $value);
    }
}
...
if ((is_numeric($value) && $value != 0)) {
    discover_sensor($valid['sensor'], 'temperature', $device, $oid, $index, 'extreme-voss', $descr, '1', '1', null, null, null, null, $value);
}
