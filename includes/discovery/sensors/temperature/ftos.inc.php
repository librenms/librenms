...
if (is_array($oids)) {
    foreach ($oids as $index => $entry) {
        ...
        discover_sensor(null, \LibreNMS\Enum\Sensor::TEMPERATURE, $device, $entry['oid'], $index, 'ftos-cseries', $entry['descr'], '1', '1', null, null, null, null, $entry['current']);
    }
}
...
if (is_array($oids)) {
    foreach ($oids as $index => $entry) {
        ...
        discover_sensor(null, \LibreNMS\Enum\Sensor::TEMPERATURE, $device, $oid, $index, 'ftos-eseries', $descr, '1', '1', null, null, null, null, $current);
    }
}
