 ...
 * compas.inc.php
 *
 * LibreNMS temperature sensor discovery module for Alpha Comp@s UPS
 *
 ...
 */
$batteryTemp = snmp_get($device, 'es1dc1DataBatBatTemp.0', '-Ovqe', 'SITE-MONITORING-MIB');
$curOID = '.1.3.6.1.4.1.26854.3.2.1.20.1.20.1.13.3.71.0';
$index = 0;
