...
$sensors_adva = [
    ...
    ['sensor_oid' => '.1.3.6.1.4.1.2544.1.12.3.1.20.1.6', 'sensor_name' => 'ethernetSWFCardTemperature'],
    ...
    ['sensor_oid' => '.1.3.6.1.4.1.2544.1.12.3.1.33.1.6', 'sensor_name' => 'ethernetOverOCSTMCardTemperature'],
    ['sensor_oid' => '.1.3.6.1.4.1.2544.1.12.3.1.36.1.6', 'sensor_name' => 'ethernet1x10GHighPerCardTemperature'],
    ...
    ['sensor_oid' => '.1.3.6.1.4.1.2544.1.12.3.1.38.1.5', 'sensor_name' => 'ethernetNTET1804CardTemperature'],
