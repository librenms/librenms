...
switch ($device['sysObjectID']) {
    ...
    case '.1.3.6.1.4.1.674.10895.3028': /* Dell Powerconnect 2848 */
        ...
        discover_sensor(null, \LibreNMS\Enum\Sensor::TEMPERATURE, $device, '.1.3.6.1.4.1.89.53.15.1.9.1', 0, 'powerconnect', 'Internal Temperature', '1', '1', '0', null, null, '45', $temperature);
        break;
    default:
        /**
        ...
        if (is_numeric($temperature)) {
            discover_sensor(null, \LibreNMS\Enum\Sensor::TEMPERATURE, $device, '.1.3.6.1.4.1.674.10895.5000.2.6132.1.1.43.1.8.1.4.0', 0, 'powerconnect', 'Internal Temperature', '1', '1', '0', null, null, '45', $temperature);
        }
}
...
foreach (explode("\n", (string) $temps) as $t) {
    ...
    if (str_ends_with($oid, '1')) {
        ...
        $counter += 1;
        discover_sensor(null, \LibreNMS\Enum\Sensor::TEMPERATURE, $device, $oid, $counter, 'dnos', 'Unit ' . $counter . ' CPU temperature', '1', '1', null, null, null, null, $val);
    }
}
...
if (is_array($oids)) {
    foreach ($oids as $index => $entry) {
        ...
        discover_sensor(null, \LibreNMS\Enum\Sensor::TEMPERATURE, $device, $oid, $index, 'ftos-sseries', $descr, '1', '1', null, null, null, null, $current);
    }
}
