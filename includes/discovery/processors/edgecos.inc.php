...
if ($device['os'] == 'edgecos') {
    ...
    if (!empty($usage = snmp_get($device, '.1.3.6.1.4.1.259.10.1.24.1.39.2.1.0', '-Ovqn'))) { //ECS4510
        $oid = '.1.3.6.1.4.1.259.10.1.24.1.39.2.1.0';
    } elseif (!empty($usage = snmp_get($device, '.1.3.6.1.4.1.259.10.1.22.1.39.2.1.0', '-Ovqn'))) { //ECS3528
        $oid = '.1.3.6.1.4.1.259.10.1.22.1.39.2.1.0';
    } elseif (!empty($usage = snmp_get($device, '.1.3.6.1.4.1.259.10.1.45.1.39.2.1.0', '-Ovqn'))) { //ECS4120
        $oid = '.1.3.6.1.4.1.259.10.1.45.1.39.2.1.0';
    } elseif (!empty($usage = snmp_get($device, '.1.3.6.1.4.1.259.10.1.42.101.1.39.2.1.0', '-Ovqn'))) { //ECS4210
