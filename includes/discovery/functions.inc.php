        ...
        foreach ($discovery[$sensor_class]['data'] as $data) {
            ...
            foreach ($raw_data as $index => $snmp_data) {
                ...
                if ($skippedFromYaml === false && is_numeric($value)) {
                    ...
                    $divisor = (int) (isset($data['divisor']) ? YamlDiscovery::replaceValues('divisor', $index, $count, $data, $pre_cache) : ($sensor_options['divisor'] ?? 1));
                    $multiplier = (int) (isset($data['multiplier']) ? YamlDiscovery::replaceValues('multiplier', $index, $count, $data, $pre_cache) : ($sensor_options['multiplier'] ?? 1));
