...
if (starts_with($disco_device['sysDescr'], 'Linux') || starts_with($disco_device['sysObjectID'], '.1.3.6.1.4.1.8072.3.2.10')) {
    if (starts_with($disco_device['sysObjectID'], array('.1.3.6.1.4.1.10002.1', '.1.3.6.1.4.1.41112.1.4'))
