...
if ($series == 'f10SSeriesProducts') {
    $mempool['total'] = snmp_get($device, 'F10-S-SERIES-CHASSIS-MIB::chSysProcessorMemSize.1', '-OvQU');
    $mempool['used']  = $mempool['total'] * (snmp_get($device, 'F10-S-SERIES-CHASSIS-MIB::chStackUnitMemUsageUtil.1', '-OvQU')/ 100);
