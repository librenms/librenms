...
$serial        = snmp_getnext($device, '.1.3.6.1.4.1.25053.1.8.1.1.1.1.1.1.1', "-OQv");
$features      = "Licenses (Used/Available): " . snmp_getnext($device, '.1.3.6.1.4.1.25053.1.8.1.1.1.1.1.1.19', "-OQv") . "/" . snmp_getnext($device, '.1.3.6.1.4.1.25053.1.8.1.1.1.1.1.1.10', "-OQv");
