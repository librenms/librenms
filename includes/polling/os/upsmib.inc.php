 ...
 * upsmib.inc.php
 *
 * LibreNMS os poller module for Generic UPS-MIB Devices
 *
...
foreach ($tempdata as $index => $data) {
    ...
    $version  = 'XXXX ' . $data['upsIdentAgentSoftwareVersion'] . $data['upsIdentUPSSoftwareVersion'];
    $features = $data['upsIdentAttachedDevices'];
}
unset($temp_data);
