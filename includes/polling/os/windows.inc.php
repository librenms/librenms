...
if($sysObjectID == ".1.3.6.1.4.1.311.1.1.3.1.1") { ## Workstation
  ...
  if (strstr($sysDescr, "Build Number: 1057")) { $version = "NT 3.51 Workstation"; }
  if (strstr($sysDescr, "Build Number: 1381")) { $version = "NT 4.0 Workstation"; }
  if (strstr($sysDescr, "Build 2195"))         { $version = "2000 (NT 5.0)"; }
  if (strstr($sysDescr, "Build 2600"))         { $version = "XP (NT 5.1)"; }
  if (strstr($sysDescr, "Build 3790"))         { $version = "XP x64 (NT 5.2)"; }
  if (strstr($sysDescr, "Build 6000"))         { $version = "Vista (NT 6.0)"; }
  if (strstr($sysDescr, "Build 6001"))         { $version = "Vista SP1 (NT 6.0)"; }
  if (strstr($sysDescr, "Build 6002"))         { $version = "Vista SP2 (NT 6.0)"; }
  if (strstr($sysDescr, "Build 7600"))         { $version = "7 (NT 6.1)"; }

} elseif ($sysObjectID == ".1.3.6.1.4.1.311.1.1.3.1.2") { ## Server

  if (strstr($sysDescr, "Build Number: 1057")) { $version = "NT Server 3.51"; }
  if (strstr($sysDescr, "Build Number: 1381")) { $version = "NT Server 4.0"; }
  if (strstr($sysDescr, "Build 2195"))         { $version = "2000 Server (NT 5.0)"; }
  if (strstr($sysDescr, "Build 3790"))         { $version = "Server 2003 (NT 5.2)"; }
  if (strstr($sysDescr, "Build 6001"))         { $version = "Server 2008 (NT 6.0)"; }
  if (strstr($sysDescr, "Build 6002"))         { $version = "Server 2008 SP2 (NT 6.0)"; }
  if (strstr($sysDescr, "Build 7600"))         { $version = "Server 2008 R2(NT 6.1)"; }

} elseif ($sysObjectID == ".1.3.6.1.4.1.311.1.1.3.1.3") { ## Datacentre Server

  if (strstr($sysDescr, "Build Number: 1057")) { $version = "NT Datacenter 3.51"; }
  if (strstr($sysDescr, "Build Number: 1381")) { $version = "NT Datacenter 4.0"; }
  if (strstr($sysDescr, "Build 2195"))         { $version = "2000 Datacenter Server (NT 5.0)"; }
  if (strstr($sysDescr, "Build 3790"))         { $version = "Server 2003 Datacenter (NT 5.2)"; }
  if (strstr($sysDescr, "Build 6001"))         { $version = "Server 2008 Datacenter (NT 6.0)"; }
  if (strstr($sysDescr, "Build 6002"))         { $version = "Server 2008 Datacenter SP2 (NT 6.0)"; }
  if (strstr($sysDescr, "Build 7600"))         { $version = "Server 2008 Datacenter R2 (NT 6.1)"; }

}

if (strstr($sysDescr, "Uniprocessor"))   { $features = "Uniprocessor"; }
if (strstr($sysDescr, "Multiprocessor")) { $features = "Multiprocessor"; }
