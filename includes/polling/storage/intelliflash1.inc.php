 ...
 */
if (!is_array($storage_cache['intelliflash1'])) {
    $storage_cache['intelliflash1'] = snmpwalk_cache_oid($device, 'poolEntry', null, 'TEGILE-MIB');
    d_echo($storage_cache);
}
$entry = $storage_cache['intelliflash1'][$storage[storage_index]];
$storage['units'] = 1;
