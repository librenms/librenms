...
foreach ($ifIndex_array as $ifIndex) {
    ...
    if (stristr($ifDescr, "Radio")) {
        ...
        $mib_oids["fibeAir4800OduAirTxPower.$ifIndex"] = array(
            "",
...
/*        $mib_oids["genEquipRadioStatusMSE.$ifIndex"] = array(
        ...
        $mib_oids["fibeAir4800OduAirBadFrames.$ifIndex"] = array(
            "",
            "radio".$radioNumber."DefectedBlocks",
            $ifName." Defected Blocks",
            "GAUGE",
        );
        $mib_oids["fibeAir4800OduAirCurrentRateIdx.$ifIndex"] = array(
            "",
...
poll_mib_def($device, " CERAGON-NET-MIB-FIBEAIR-4800:ceragon-radio", "fibeair", $mib_oids, $mib_graphs, $graphs);
