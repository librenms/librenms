...
if (is_string($powerdns_dnsdist)) {
    ...
    $rrd_def = RrdDefinition::make()
        ->addDataset('cache_hits', 'GAUGE', 0)
        ->addDataset('cache_miss', 'GAUGE', 0)
        ->addDataset('downstream_err', 'GAUGE', 0)
        ->addDataset('downstream_timeout', 'GAUGE', 0)
        ->addDataset('dynamic_block_size', 'GAUGE', 0)
        ->addDataset('dynamic_blocked', 'GAUGE', 0)
        ->addDataset('queries_count', 'GAUGE', 0)
        ->addDataset('queries_recursive', 'GAUGE', 0)
        ->addDataset('queries_empty', 'GAUGE', 0)
        ->addDataset('queries_drop_no_policy', 'GAUGE', 0)
        ->addDataset('queries_drop_nc', 'GAUGE', 0)
        ->addDataset('queries_drop_nc_answer', 'GAUGE', 0)
        ->addDataset('queries_self_answer', 'GAUGE', 0)
        ->addDataset('queries_serv_fail', 'GAUGE', 0)
        ->addDataset('queries_failure', 'GAUGE', 0)
        ->addDataset('queries_acl_drop', 'GAUGE', 0)
        ->addDataset('rule_drop', 'GAUGE', 0)
        ->addDataset('rule_nxdomain', 'GAUGE', 0)
        ->addDataset('rule_refused', 'GAUGE', 0)
        ...
        ->addDataset('latency_slow', 'GAUGE', 0)
        ->addDataset('latency_0_1', 'GAUGE', 0)
        ->addDataset('latency_1_10', 'GAUGE', 0)
        ->addDataset('latency_10_50', 'GAUGE', 0)
        ->addDataset('latency_50_100', 'GAUGE', 0)
        ->addDataset('latency_100_1000', 'GAUGE', 0);
