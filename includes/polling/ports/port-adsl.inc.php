...
if (isset($this_port['adslLineCoding'])) {
    ...
    $rrd_def = array(
        'DS:AtucCurrSnrMgn:GAUGE:'.$config['rrd']['heartbeat'].':0:635',
        'DS:AtucCurrAtn:GAUGE:'.$config['rrd']['heartbeat'].':0:635',
        'DS:AtucCurrOutputPwr:GAUGE:'.$config['rrd']['heartbeat'].':0:635',
        'DS:AtucCurrAttainableR:GAUGE:'.$config['rrd']['heartbeat'].':0:U',
        'DS:AtucChanCurrTxRate:GAUGE:'.$config['rrd']['heartbeat'].':0:U',
        'DS:AturCurrSnrMgn:GAUGE:'.$config['rrd']['heartbeat'].':0:635',
        'DS:AturCurrAtn:GAUGE:'.$config['rrd']['heartbeat'].':0:635',
        'DS:AturCurrOutputPwr:GAUGE:'.$config['rrd']['heartbeat'].':0:635',
        'DS:AturCurrAttainableR:GAUGE:'.$config['rrd']['heartbeat'].':0:U',
        'DS:AturChanCurrTxRate:GAUGE:'.$config['rrd']['heartbeat'].':0:U',
        'DS:AtucPerfLofs:COUNTER:'.$config['rrd']['heartbeat'].':U:100000000000',
        'DS:AtucPerfLoss:COUNTER:'.$config['rrd']['heartbeat'].':U:100000000000',
        'DS:AtucPerfLprs:COUNTER:'.$config['rrd']['heartbeat'].':U:100000000000',
        'DS:AtucPerfESs:COUNTER:'.$config['rrd']['heartbeat'].':U:100000000000',
        'DS:AtucPerfInits:COUNTER:'.$config['rrd']['heartbeat'].':U:100000000000',
        'DS:AturPerfLofs:COUNTER:'.$config['rrd']['heartbeat'].':U:100000000000',
        'DS:AturPerfLoss:COUNTER:'.$config['rrd']['heartbeat'].':U:100000000000',
        'DS:AturPerfLprs:COUNTER:'.$config['rrd']['heartbeat'].':U:100000000000',
        'DS:AturPerfESs:COUNTER:'.$config['rrd']['heartbeat'].':U:100000000000',
        'DS:AtucChanCorrectedBl:COUNTER:'.$config['rrd']['heartbeat'].':U:100000000000',
        'DS:AtucChanUncorrectBl:COUNTER:'.$config['rrd']['heartbeat'].':U:100000000000',
        'DS:AturChanCorrectedBl:COUNTER:'.$config['rrd']['heartbeat'].':U:100000000000',
        'DS:AturChanUncorrectBl:COUNTER:'.$config['rrd']['heartbeat'].':U:100000000000',
    );
