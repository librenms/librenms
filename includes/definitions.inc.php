...
$config['graph_types']['device']['panos_vsys_active_udp_cps']['order']    = '1';
...
$config['graph_types']['device']['panos_vsys_active_tcp_cps']['order']    = '1';
...
$config['graph_types']['device']['panos_vsys_active_other_ip_cps']['order']    = '1';
