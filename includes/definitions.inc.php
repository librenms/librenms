...
$config['graph_types']['device']['fortigate_npu_drops']['section']       = 'system';
$config['graph_types']['device']['fortigate_npu_drops']['order']         = '0';
$config['graph_types']['device']['fortigate_npu_drops']['descr']         = 'NPU Drops';
