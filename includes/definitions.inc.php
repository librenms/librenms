...
$config['os'][$os]['poller_modules']['cisco-ipsec-flow-monitor']    = 0;
$config['os'][$os]['poller_modules']['cisco-remote-access-monitor'] = 0;
$config['os'][$os]['poller_modules']['cisco-sla']                   = 0;
$config['os'][$os]['poller_modules']['cipsec-tunnels']              = 0;
$config['os'][$os]['poller_modules']['cisco-asa-firewall']          = 0;
$config['os'][$os]['poller_modules']['cisco-otv']                   = 0;
$config['os'][$os]['discovery_modules']['aruba-controller']         = 0;
$config['os'][$os]['discovery_modules']['bgp-peers']                = 0;
$config['os'][$os]['discovery_modules']['cisco-cbqos']              = 0;
$config['os'][$os]['discovery_modules']['cisco-cef']                = 0;
$config['os'][$os]['discovery_modules']['cisco-sla']                = 0;
$config['os'][$os]['discovery_modules']['cisco-mac-accounting']     = 0;
$config['os'][$os]['discovery_modules']['cisco-otv']                = 0;
$config['os'][$os]['discovery_modules']['cisco-pw']                 = 0;
$config['os'][$os]['discovery_modules']['cisco-vrf']                = 0;
$config['os'][$os]['discovery_modules']['cisco-vrf-lite']           = 0;
$config['os'][$os]['discovery_modules']['junose-atm-vp']            = 0;
$config['os'][$os]['discovery_modules']['stp']                      = 0;
$config['os'][$os]['discovery_modules']['toner']                    = 0;
$config['os'][$os]['discovery_modules']['vmware-vminfo']            = 0;
