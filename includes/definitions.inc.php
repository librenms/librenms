...
$config['os'][$os]['poller_modules']['wifi']                        = 0;
...
$config['os'][$os]['discovery_modules']['vmware-vminfo']            = 1;
...
$config['os'][$os]['over'][2]['graph']                              = 'device_mempool';
$config['os'][$os]['over'][2]['text']                               = 'Memory Usage';
$config['os'][$os]['poller_modules']['cisco-cbqos']                 = 1;
$config['os'][$os]['poller_modules']['cisco-cef']                   = 1;
$config['os'][$os]['poller_modules']['cisco-mac-accounting']        = 1;
$config['os'][$os]['poller_modules']['cisco-voice']                 = 1;
$config['os'][$os]['poller_modules']['cisco-remote-access-monitor'] = 1;
$config['os'][$os]['poller_modules']['cisco-sla']                   = 1;
$config['os'][$os]['poller_modules']['cisco-ipsec-flow-monitor']    = 1;
$config['os'][$os]['poller_modules']['cipsec-tunnels']              = 1;
$config['os'][$os]['poller_modules']['cisco-otv']                   = 1;
$config['os'][$os]['discovery_modules']['cisco-cef']                = 1;
$config['os'][$os]['discovery_modules']['cisco-sla']                = 1;
$config['os'][$os]['discovery_modules']['cisco-mac-accounting']     = 1;
$config['os'][$os]['discovery_modules']['cisco-otv']                = 1;
...
$config['os'][$os]['poller_modules']['cisco-ace-serverfarms']       = 1;
$config['os'][$os]['poller_modules']['cisco-ace-loadbalancer']      = 1;
$config['os'][$os]['poller_modules']['cisco-cbqos']                 = 1;
$config['os'][$os]['poller_modules']['cisco-cef']                   = 1;
$config['os'][$os]['poller_modules']['cisco-mac-accounting']        = 1;
$config['os'][$os]['poller_modules']['cisco-voice']                 = 1;
...
$config['os'][$os]['over'][1]['text']                               = 'CPU Usage';
$config['os'][$os]['poller_modules']['bgp-peers']                   = 0;
$config['os'][$os]['poller_modules']['cisco-asa-firewall']          = 1;
$config['os'][$os]['poller_modules']['cisco-cbqos']                 = 1;
$config['os'][$os]['poller_modules']['cisco-cef']                   = 1;
$config['os'][$os]['poller_modules']['cisco-mac-accounting']        = 1;
$config['os'][$os]['poller_modules']['cisco-voice']                 = 1;
...
$config['os'][$os]['over'][2]['graph']                              = 'device_mempool';
$config['os'][$os]['over'][2]['text']                               = 'Memory Usage';
$config['os'][$os]['poller_modules']['junose-atm-vp']               = 1;
$config['os'][$os]['poller_modules']['wifi']                        = 0;
$config['os'][$os]['poller_modules']['toner']                       = 0;
$config['os'][$os]['discovery_modules']['junose-atm-vp']            = 1;
$config['os'][$os]['discovery_modules']['toner']                    = 0;
...
$config['os'][$os]['poller_modules']['aruba-controller'] = 1;
