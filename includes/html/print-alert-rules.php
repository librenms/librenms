...
foreach ($rule_list as $rule) {
    ...
    echo "<a class='btn btn-primary' href='/alert-rules/create?rule_id=" . $rule['id'] . "' title='Edit alert rule' data-content='" . htmlentities($rule['name']) . "' data-container='body'><i class='fa fa-lg fa-pencil' aria-hidden='true'></i></a> ";
