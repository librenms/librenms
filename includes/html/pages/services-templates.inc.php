                    ...
                    foreach ($services_template as $service_template) {
                        ...
                        if (Auth::user()->hasGlobalAdmin()) {
                            echo "<td>
                                    ...
                                    <button type='button' class='btn btn-warning btn-sm' aria-label='Remove' data-toggle='modal' data-target='#remove-service-template' data-service_template_id='{$service_template['service_template_id']}' name='remove-service-template'><i class='fa fa-retweet' aria-hidden='true'></i></button>
