                ...
                foreach (dbFetchRows($host_sql, $host_par) as $device_group) {
                    ...
                    foreach ($services_template as $service_template) {
                        ...
                        if (Auth::user()->hasGlobalAdmin()) {
                            echo "<td>
                                    <button type='button' class='btn btn-success btn-sm' aria-label='Apply' data-toggle='modal' data-target='#discover-service-template' data-device_group_id='{$device_group_id}' data-service_template_id='{$service_template['service_template_id']}' name='discover-service-template'><i class='fa fa-retweet' aria-hidden='true'></i></button>
                                    <button type='button' class='btn btn-danger btn-sm' aria-label='Apply' data-toggle='modal' data-target='#discover-service-template' data-device_group_id='{$device_group_id}' data-service_template_id='{$service_template['service_template_id']}' name='discover-service-template'><i class='fa fa-retweet' aria-hidden='true'></i></button>
