...
foreach (Application::query()->hasAccess(Auth::user())->with('device')->orderBy('app_type')->get()->sortBy('show_name', SORT_NATURAL|SORT_FLAG_CASE)->groupBy('app_type') as $type => $groupedApps) {
