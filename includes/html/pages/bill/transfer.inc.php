...
$fromtext = dbFetchCell("SELECT DATE_FORMAT($datefrom, '" . \App\Facades\Config::get('dateformat.mysql.date') . "')");
$totext = dbFetchCell("SELECT DATE_FORMAT($dateto, '" . \App\Facades\Config::get('dateformat.mysql.date') . "')");
...
$ousage['data'] = \LibreNMS\Util\Number::formatBase($ousage['over'], \App\Facades\Config::get('billing.base'), 2, 3, '');
...
$di .= '&amp;from=' . \App\Facades\Config::get('time.day') . '&amp;to=' . \App\Facades\Config::get('time.now');
$di .= '&amp;imgtype=hour';
