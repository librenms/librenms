...
$total['data'] = \LibreNMS\Billing::formatBytes($bill_data['total_data']);
if ($bill_data['bill_type'] == 'quota') {
    $total['allow'] = \LibreNMS\Billing::formatBytes($bill_data['bill_quota']);
} else {
    $total['allow'] = '-';
}

$total['ave'] = \LibreNMS\Billing::formatBytes(($bill_data['total_data'] / $cur_days));
$total['est'] = \LibreNMS\Billing::formatBytes(($bill_data['total_data'] / $cur_days * $total_days));
if ($bill_data['bill_type'] == 'quota') {
...
$in['data'] = \LibreNMS\Billing::formatBytes($bill_data['total_data_in']);
$in['allow'] = $total['allow'];
$in['ave'] = \LibreNMS\Billing::formatBytes(($bill_data['total_data_in'] / $cur_days));
$in['est'] = \LibreNMS\Billing::formatBytes(($bill_data['total_data_in'] / $cur_days * $total_days));
...
$out['data'] = \LibreNMS\Billing::formatBytes($bill_data['total_data_out']);
$out['allow'] = $total['allow'];
$out['ave'] = \LibreNMS\Billing::formatBytes(($bill_data['total_data_out'] / $cur_days));
$out['est'] = \LibreNMS\Billing::formatBytes(($bill_data['total_data_out'] / $cur_days * $total_days));
...
$ousage['ave'] = \LibreNMS\Billing::formatBytes(($ousage['over'] / $cur_days));
$ousage['est'] = \LibreNMS\Billing::formatBytes(($ousage['over'] / $cur_days * $total_days));
