    ...
    <div class="table-responsive">
        <table id="toner" class="table table-hover table-condensed mempool">
            ...
            <tr>
                ...
                <th data-column-id="printer_descr">Toner</th>
                <th data-column-id="printer_type" data-searchable="false">Type</th>
                <th data-column-id="graph" data-sortable="false" data-searchable="false"></th>
                <th data-column-id="toner_used" data-searchable="false">Used</th>
                <th data-column-id="printer_current" data-searchable="false">Usage</th>
            </tr>
            </thead>
        </table>
    </div>
