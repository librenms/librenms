...
if (count($drives)) {
    ...
    foreach ($drives as $drive) {
        ...
        echo '<tr>
           ...
           <td class="col-md-4">' . \LibreNMS\Util\Url::overlibLink($link, print_percentage_bar(400, 10, $percent, "$used / $total ($percent%)", null, $background['left'], $free, null, $background['right']), $overlib_content) . '
           </a></td>
         </tr>';
    }//end foreach
