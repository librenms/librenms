...
$( ".sensor" ).on('blur keyup',function(e) {
    ...
    $.ajax({
        type: 'POST',
            url: 'ajax_form.php',
            data: { type: "wireless-sensor-update", device_id: device_id, data: data, sensor_id: sensor_id , value_type: value_type},
            dataType: "json",
            success: function(data){
            if (data.status == 'ok') {
...
$('input[name="alert-status"]').on('switchChange.bootstrapSwitch',  function(event, state) {
    ...
    $.ajax({
        type: 'POST',
            url: 'ajax_form.php',
            data: { type: "wireless-sensor-alert-update", device_id: device_id, sensor_id: sensor_id, sensor_desc: sensor_desc, state: state},
            dataType: "json",
            success: function(data){
...
$("[name='remove-custom']").on('click', function(event) {
    ...
    $.ajax({
        type: 'POST',
            url: 'ajax_form.php',
            data: { type: "wireless-sensor-alert-update", sensor_id: sensor_id, sub_type: "remove-custom" },
            dataType: "json",
            success: function(data){
                toastr.success(data.message);
