...
<object data="<?php echo asset("graph-realtime.php"); ?>?type=bits&id=<?php echo $port['port_id'].'&interval='.$vars['interval']; ?>" type="image/svg+xml" width="1000" height="400">
<param name="src" value="<?php echo asset("graph.php"); ?>?type=bits&id=<?php echo $port['port_id'].'&interval='.$vars['interval']; ?>" />
