...
if ($app_data['version'] == 1) {
    ...
    if (strcmp($vars['suricata_graph_set'], 'general') == 0) {
        ...
        $graphs = [
            ...
            'suricata_v2_app_layer__error__tft__alloc' => 'TFTP, alloc errors/second',
        ...
        $graphs = [
            ...
            'suricata_v2_app_layer__error__dcerpc_udp__gap' => 'DCE RPC UDP, gap errors/second',
            ...
            'suricata_v2_app_layer__error__dns_udp__gap' => 'DNS UDP, gap errors/second',
            'suricata_v2_app_layer__error__enip_tcp__gap' => 'ENIP TCP, gap errors/second',
            'suricata_v2_app_layer__error__enip_udp__gap' => 'ENIP UDP, gap errors/second',
            ...
            'suricata_v2_app_layer__error__krb5_udp__gap' => 'KRB5 UDP, gap errors/second',
            ...
            'suricata_v2_app_layer__error__nfs_udp__gap' => 'NFS UDP, gap errors/second',
            ...
            'suricata_v2_app_layer__error__tft__gap' => 'TFTP, gap errors/second',
