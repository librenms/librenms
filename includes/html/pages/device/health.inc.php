...
$concentration         = dbFetchCell("select count(*) from sensors WHERE sensor_class='concentration' AND device_id = ?", array($device['device_id']));
...
$type_text['concentration']        = 'Concentration';
