 ...
 <li class='$class'>";
        ...
        if ($sensors->count() == 1) {
            foreach ($sensors as $sensor) {
                ...
                echo "<a href='graphs/id=" . $sensor->sensor_id . '/type=' . $graphType . "/' onmouseover=\"return overlib('<img src=\'graph.php?id=" . $sensor->sensor_id . '&amp;type=' . $graphType . '&amp;from=-2d&amp;to=now&amp;width=400&amp;height=150&amp;a=' . $ent['entPhysical_id'] . "\'><img src=\'graph.php?id=" . $sensor->sensor_id . '&amp;type=' . $graphType . '&amp;from=-2w&amp;to=now&amp;width=400&amp;height=150&amp;a=' . $ent['entPhysical_id'] . "\'>', LEFT,FGCOLOR,'#e5e5e5', BGCOLOR, '#c0c0c0', BORDER, 5, CELLPAD, 4, CAPCOLOR, '#050505');\" onmouseout=\"return nd();\">";
        ...
        if ($sensors->count() > 1) {
            ...
            foreach ($sensors as $sensor) {
                ...
                $graphType = $sensor->getGraphType();
                echo "<a href='graphs/id=" . $sensor->sensor_id . '/type=' . $graphType . "/' onmouseover=\"return overlib('<img src=\'graph.php?id=" . $sensor->sensor_id . '&amp;type=' . $graphType . '&amp;from=-2d&amp;to=now&amp;width=400&amp;height=150&amp;a=' . $ent['entPhysical_id'] . "\'><img src=\'graph.php?id=" . $sensor->sensor_id . '&amp;type=' . $graphType . '&amp;from=-2w&amp;to=now&amp;width=400&amp;height=150&amp;a=' . $ent['entPhysical_id'] . "\'>', LEFT,FGCOLOR,'#e5e5e5', BGCOLOR, '#c0c0c0', BORDER, 5, CELLPAD, 4, CAPCOLOR, '#050505');\" onmouseout=\"return nd();\">";
                echo "<span style='color: #000099;'>" . $disp_name . ' ' . $sensor->sensor_class->shortLabel() . '</span>';
                echo ' ';
                echo Html::severityToLabel($sensor->currentStatus(), $sensor->formatValue());
                echo '</a><br>';
            }
