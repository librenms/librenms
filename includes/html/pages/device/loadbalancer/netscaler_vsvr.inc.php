...
if (is_numeric($vars['vsvr'])) {
    ...
    foreach ($vservers as $vsvr) {
        ...
        echo '<td><a href="' . generate_url($vars, ['vsvr' => $vsvr['vsvr_id'], 'view' => null, 'graph' => null]) . '">' . $vsvr['vsvr_name'] . '</a></td>';
    ...
    foreach ($menu_options as $option => $text) {
        ...
        echo '<a href="' . generate_url($vars, ['view' => 'basic', 'graph' => null]) . '">' . $text . '</a>';
        if ($vars['view'] == $option) {
            echo '</span>';
        }
    ...
    foreach ($graph_types as $type => $descr) {
        ...
        echo '<a href="' . generate_url($vars, ['view' => 'graphs', 'graph' => $type]) . '">' . $descr . '</a>';
        if ($vars['graph'] == $type) {
            echo '</span>';
        }
