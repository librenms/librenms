                ...
                foreach (dbFetchRows($host_sql, $host_par) as $device) {
                    ...
                    foreach ($services as $service) {
                        ...
                        if ($service_iteration < 2 && $header) {
                            ...
                            echo '<th style="width:5%;max-width: 10%;">Name</th>';
                            echo '<th style="width:5%;max-width: 10%;">Check Type</th>';
                            echo '<th style="width:10%;max-width: 15%;">Remote Host</th>';
                            echo '<th >Message</th>';
                            echo '<th style="width:20%;max-width: 35%;">Description</th>';
                            echo '<th style="width:12%;max-width: 12%;">Last Changed</th>';
