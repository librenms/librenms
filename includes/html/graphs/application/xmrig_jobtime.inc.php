...
such as to verify your pool is allocating a sensible difficulty for each share.
You can also set up alerts using this data source. For example, if you lose
connection to a pool and stop getting jobs, your threads will drop and you can
trigger an alert
