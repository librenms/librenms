...
$rrd_options[] = 'AREA:InForwDatagrams#AF63AF' . $stacked['transparency'] . ':InForward    v4';
...
$rrd_options[] = "AREA:InDelivers#CDEB8B{$stacked['transparency']}:'InDelivers   v4':STACK";
...
$rrd_options[] = 'AREA:OutRequests_n#C3D9FF' . $stacked['transparency'] . ':OutRequests  v4';
...
$rrd_options[] = 'AREA:OutForwDatagrams#AF63AF' . $stacked['transparency'] . ':OutForward   v4';
