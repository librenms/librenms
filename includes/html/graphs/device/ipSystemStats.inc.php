...
$rrd_options[] = 'CDEF:OutForwDatagrams_4_n=OutForwDatagrams_4,' . $stacked['stacked'] . ',*';
$rrd_options[] = "DEF:OutRequests_4=$rrd_filename_4:OutRequests:AVERAGE";
$rrd_options[] = 'CDEF:OutRequests_4_n=OutRequests_4,' . $stacked['stacked'] . ',*';
$rrd_options[] = "DEF:OutDiscards_4=$rrd_filename_4:OutDiscards:AVERAGE";
$rrd_options[] = 'CDEF:OutDiscards_4_n=OutDiscards_4,' . $stacked['stacked'] . ',*';
$rrd_options[] = "DEF:OutNoRoutes_4=$rrd_filename_4:InDiscards:AVERAGE";
$rrd_options[] = 'CDEF:OutNoRoutes_4_n=OutNoRoutes_4,' . $stacked['stacked'] . ',*';
...
$rrd_options[] = 'CDEF:OutForwDatagrams_6_n=OutForwDatagrams_6,' . $stacked['stacked'] . ',*';
$rrd_options[] = "DEF:OutRequests_6=$rrd_filename_6:OutRequests:AVERAGE";
$rrd_options[] = 'CDEF:OutRequests_6_n=OutRequests_6,' . $stacked['stacked'] . ',*';
$rrd_options[] = "DEF:OutDiscards_6=$rrd_filename_6:OutDiscards:AVERAGE";
$rrd_options[] = 'CDEF:OutDiscards_6_n=OutDiscards_6,' . $stacked['stacked'] . ',*';
$rrd_options[] = "DEF:OutNoRoutes_6=$rrd_filename_6:InDiscards:AVERAGE";
$rrd_options[] = 'CDEF:OutNoRoutes_6_n=OutNoRoutes_6,' . $stacked['stacked'] . ',*';

$rrd_options[] = 'COMMENT:Packets/sec       Current  Average  Maximum\\n';

$rrd_options[] = 'AREA:InReceives_4#CDEB8B' . $stacked['transparency'] . ':InReceives   v4';
...
$rrd_options[] = "AREA:InReceives_6#8C9E5E{$stacked['transparency']}:'             v6':STACK";
...
$rrd_options[] = 'AREA:OutRequests_4_n#C3D9FF' . $stacked['transparency'] . ':OutRequests  v4';
...
$rrd_options[] = "AREA:OutRequests_6_n#8D9CB7{$stacked['transparency']}:'             v6':STACK";
...
$rrd_options[] = 'AREA:InForwDatagrams_4#AF63AF' . $stacked['transparency'] . ':InForward    v4';
...
$rrd_options[] = "AREA:InForwDatagrams_6#3F003F{$stacked['transparency']}:'             v6':STACK";
...
$rrd_options[] = 'AREA:OutForwDatagrams_4#AF63AF' . $stacked['transparency'] . ':OutForward   v4';
...
$rrd_options[] = "AREA:OutForwDatagrams_6#3F003F{$stacked['transparency']}:'             v6':STACK";
