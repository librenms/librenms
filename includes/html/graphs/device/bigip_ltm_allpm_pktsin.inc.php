...
$colours = array_merge(\App\Facades\Config::get('graph_colours.mixed'), \App\Facades\Config::get('graph_colours.manycolours'), \App\Facades\Config::get('graph_colours.manycolours'));
$count = 0;
d_echo('<pre>');
