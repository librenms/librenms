...
$rrd_options[] = 'CDEF:doutoctetsc=outoctetsc,' . $stacked['stacked'] . ',*';
...
$rrd_options[] = 'CDEF:doutbits_stot=outbits_stot,' . $stacked['stacked'] . ',*';
...
if ($legend == 'no') {
    ...
    $rrd_options[] = 'AREA:doutbits_tot#' . ($stacked['stacked'] === '1' ? 'b7c9ff' : 'cdeb8b') . $stacked['transparency'] . ':';
    $rrd_options[] = 'LINE1.25:inbits_tot#aacc77:';
    $rrd_options[] = 'LINE1.25:doutbits_tot#' . ($stacked['stacked'] === '1' ? '6677bb' : 'aacc88') . ':';
    $rrd_options[] = 'AREA:inbits_stot#c3d9ff' . $stacked['transparency'] . ':';
    $rrd_options[] = 'AREA:doutbits_stot#' . ($stacked['stacked'] === '1' ? 'edb8da' : 'c3d9ff') . $stacked['transparency'] . ':';
    $rrd_options[] = 'LINE1:inbits_stot#b3a9cf:';
    $rrd_options[] = 'LINE1:doutbits_stot#' . ($stacked['stacked'] === '1' ? 'b95c91' : 'b3a9cf') . ':';
    $rrd_options[] = 'AREA:inbitsc#ffcc99' . $stacked['transparency'] . ':';
    $rrd_options[] = 'AREA:doutbitsc#' . ($stacked['stacked'] === '1' ? '99bbff' : 'ffcc99') . $stacked['transparency'] . ':';
    $rrd_options[] = 'LINE1.25:inbitsc#ddaa88';
    $rrd_options[] = 'LINE1.25:doutbitsc#' . ($stacked['stacked'] === '1' ? '5577bb' : 'ddaa88') . '';
    $rrd_options[] = 'LINE1:inbits#006600:';
    $rrd_options[] = 'LINE1:doutbits#' . ($stacked['stacked'] === '1' ? 'cc6600' : '006600') . ':';
    $rrd_options[] = 'LINE1:inbitsb#000099:';
    $rrd_options[] = 'LINE1:doutbitsb#' . ($stacked['stacked'] === '1' ? '990066' : '000099') . ':';
    $rrd_options[] = 'LINE0.5:nothing#555555:';
} else {
    $rrd_options[] = "COMMENT:bps\ \ \ \ \ \ \ \ \ \ \ \ Current\ \ \ Average\ \ \ \ \ \ Min\ \ \ \ \ \ Max\\\\n";
    $rrd_options[] = 'AREA:inbits_tot#cdeb8b' . $stacked['transparency'] . ':ATM\ \ In\ ';
    ...
    $rrd_options[] = 'LINE1.25:inbits_tot#aacc77:';
    $rrd_options[] = 'LINE1.25:doutbits_tot#' . ($stacked['stacked'] === '1' ? '6677bb' : 'aacc88') . ':';
    $rrd_options[] = 'AREA:inbits_stot#c3d9ff' . $stacked['transparency'] . ':NGN\ \ In\ ';
    ...
    $rrd_options[] = 'LINE1:inbits_stot#b3a9cf:';
    $rrd_options[] = 'LINE1:doutbits_stot#' . ($stacked['stacked'] === '1' ? 'b95c91' : 'b3a9cf') . ':';
    $rrd_options[] = 'AREA:inbitsc#ffcc99' . $stacked['transparency'] . ':Wave\ In\ ';
