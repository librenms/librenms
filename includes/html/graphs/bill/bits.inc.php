...
if ($bill['bill_type'] == 'cdr') {
    ...
    $custom_graph[] = 'HRULE:' . ($rates['rate_95th'] * (int) generate_stacked_graphs()['stacked']) . '#cc0000';
    ...
    $custom_graph[] = 'HRULE:' . ($rates['rate_average'] * (int) generate_stacked_graphs()['stacked']) . '#cc0000';
}
