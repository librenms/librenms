                    ...
                    <form method="post" role="form" id="rules" class="form-horizontal alerts-form">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="main">
                                ...
                                <div class="form-group form-inline">
                                    <label for='maps' class='col-sm-3 col-md-2 control-label' title="Restricts this alert rule to the selected devices and groups.">Match devices, groups and locations list: </label>
