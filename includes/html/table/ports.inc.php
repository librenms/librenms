...
foreach (dbFetchRows($query, $param) as $port) {
    ...
    $response[] = [
        ...
        'ifInErrors' => \LibreNMS\Util\Number::formatSi($port['ifInErrors_delta'] / ($port['poll_period'] ?: 1), 2, 3, 'EPS'),
        'ifOutErrors' => \LibreNMS\Util\Number::formatSi($port['ifOutErrors_delta'] / ($port['poll_period'] ?: 1), 2, 3, 'EPS'),
