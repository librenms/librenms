...
$check_cmd = \App\Facades\Config::get('nagios_plugins') . '/check_icmp ' . ($service['service_ip'] ? $service['service_ip'] : $service['hostname']) . ' ' . $service['service_param'];
...
$check_graph['rtt'] .= ' LINE1.25:DS0#' . \App\Facades\Config::get('graph_colours.mixed.0') . ":'" . str_pad(substr('Round Trip Average', 0, 15), 15) . "' ";
...
$check_graph['rtt'] .= ' LINE1.25:DS1#' . \App\Facades\Config::get('graph_colours.mixed.1') . ":'" . str_pad(substr('Round Trip Max', 0, 15), 15) . "' ";
...
$check_graph['rtt'] .= ' LINE1.25:DS2#' . \App\Facades\Config::get('graph_colours.mixed.2') . ":'" . str_pad(substr('Round Trip Min', 0, 15), 15) . "' ";
...
$check_graph['pl'] .= ' AREA:DS0#' . \App\Facades\Config::get('graph_colours.mixed.2') . ":'" . str_pad(substr('Packet Loss (%)', 0, 15), 15) . "' ";
