 ...
 * @return array the fully assembled command, ready to run
 */
function gen_snmpwalk_cmd($device, $oids, $options = null, $mib = null, $mibdir = null, $communityStringIndexing = 0)
{
    ...
    return gen_snmp_cmd($snmpcmd, $device, $oids, $options, $mib, $mibdir, $communityStringIndexing);
 ...
 * @return array the fully assembled command, ready to run
 */
function gen_snmp_cmd($cmd, $device, $oids, $options = null, $mib = null, $mibdir = null, $communityStringIndexing = 0)
{
    if (!isset($device['transport'])) {
        $device['transport'] = 'udp';
    }

    $cmd = snmp_gen_auth($device, $cmd, $communityStringIndexing);
 ...
 * @return array
 */
function snmp_gen_auth(&$device, $cmd = [], $communityStringIndexing = 0)
{
    if ($device['snmpver'] === 'v3') {
        ...
        if ($communityStringIndexing != 0) {
            array_push($cmd, '-' . $device['snmpver'], '-c', $device['community'] . '@' . $communityStringIndexing);
        } else {
