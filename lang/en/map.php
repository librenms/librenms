...
return [
    'custom' => [
        ...
        'view' => [
            ...
            'legend' => 'Legend',
            'invalid_link' => 'The link is down, or the link speed is not defined',
            'go_to' => 'Go to',
            'unknown' => '???',
        ],
        'nodeimage' => [
        ...
        'edit' => [
            ...
            'bg' => [
                ...
                'saving' => 'Saving...',
                'save_errors' => 'Save failed because of the following errors:',
                'save_error' => 'Save failed. The server returned error response code :code',
                ...
                'as_image_hint' => 'An image background is static. It gives better performance and works without a connection to the map tile server',
            ],
            'map' => [
                ...
                'multiselect_info' => 'To select multiple nodes, long-click or hold down Ctrl',
                'no_group' => 'No Group',
                'width' => 'Width',
                'height' => 'Height',
        ...
        'widget' => [
            'not_found' => 'No map selected. Edit the widget to select a map.',
        ],
    ],
];
