...
return [
    ...
    'settings' => [
        ...
        'astext' => [
            'description' => 'Описания автономных систем',
            'help' => 'Список ASN и их описаний для отображения пользовательских имён в контекстах маршрутизации',
            'keyPlaceholder' => 'ASN',
            'valuePlaceholder' => 'Описание',
        ],
        'auth' => [
            'allow_get_login' => [
        ...
        'nfsen_lasts' => [
            ...
            'keyPlaceholder' => 'Секунды',
            'valuePlaceholder' => 'Метка отображения',
        ],
        'nfsen_base' => [
    ...
    'validate' => [
        ...
        'key' => 'Неверный ключ',
        'regex' => 'Неверный шаблон regex',
        'duplicate_key' => 'Ключ уже существует',
