...
//        ],
        ...
        'mysql' => [
            ...
            'read' => [
              'host' => env('DB_READ', env('DB_HOST', $fallback_db_config['db_host'])),
              'port' => env('DB_READ_PORT', env('DB_PORT', $fallback_db_config['db_port'])),
              'database' => env('DB_READ_DATABASE', env('DB_DATABASE', $fallback_db_config['db_name'])),
              'username' => env('DB_READ_USERNAME', env('DB_USERNAME', $fallback_db_config['db_user'])),
