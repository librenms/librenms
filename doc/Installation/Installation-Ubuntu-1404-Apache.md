...
Install the required software:
    ...
    apt-get install libapache2-mod-php5 php5-cli php5-mysql php5-gd php-pear php5-curl snmp graphviz php5-mcrypt php5-json apache2 fping imagemagick whois mtr-tiny nmap python-mysqldb snmpd php-net-ipv4 php-net-ipv6 rrdtool git
