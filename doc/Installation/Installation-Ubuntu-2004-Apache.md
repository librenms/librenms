source: Installation/Installation-Ubuntu-2004-Apache.md
...
# Set system timezone
Set the system timezone if it hasn't already been set.
This timezone must match the timezone used later in the PHP configuration.
To list available timezones, run `timedatectl list-timezones`.
Replace `America/New_York` with your correct timezone.
```bash
...
```bash
apt update
apt install acl curl apache2 composer fping git graphviz imagemagick libapache2-mod-php7.4 mariadb-client mariadb-server mtr-tiny nmap php7.4-cli php7.4-curl php7.4-gd php7.4-json php7.4-mbstring php7.4-mysql php7.4-snmp php7.4-xml php7.4-zip rrdtool snmp snmpd whois python3-pip
```
