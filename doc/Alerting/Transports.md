...
3. Add your bot to telegram with the following url: `http://telegram.me/<botname>` to use app ou try `https://web.telegram.org/<botname>` to use in web, and send some text to the bot.
...
5. You see a json code with the message you sent to the bot. Copy the Chat id. In this example that is “-9787468” and will b
...
7. If want to use a grouping to receive alerts, is need that pick the Chat ID of the group chat, and not of the Bot itself.
