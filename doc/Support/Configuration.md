...
> NOTE: Setting a higher timeout value than the millisec value can lead to slowing down poller. Example:
>
> timeout: 3000
>
> count: 3
...
> millisec: 500
>
> In this example, millisec will be overwritten by the timeout value of 3000 which is 3 seconds. As we send three icmp packets (count: 3), each one is delayed by 3 seconds which will result in fping taking > 6 seconds to return results.
