...
##### SNMP Extend
1. Copy the [exim stats](https://github.com/crcro/librenms-agent/blob/1c091800b713e26395796b5d5379421fc268a39b/snmp/exim-stats.sh) to `/etc/snmp/` (or any other suitable location) on your host.
