...
2. Copy the shell script to the host.
By default, the script shows only the running containers. For all
containers, change the constant at the top of the script to
