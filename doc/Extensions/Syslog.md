...
#### Juniper Junos
```ssh
$config['os']['junos']['syslog_hook'][] = Array('regex' => '/UI_COMMIT_PROGRESS: Commit operation in progress: commit complete/', 'script' => '/opt/librenms/scripts/syslog-notify-oxidized.php');
```
#### Juniper ScreenOS
```ssh
