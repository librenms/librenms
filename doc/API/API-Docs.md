...
Route: /api/v0/resources/ip/arp/:ip
  ...
  - This may also be a cidr network, for example 192.168.1.0/24, but the / needs to be properly encoded (%2F)
...
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://librenms.org/api/v0/resources/ip/arp/192.168.1.0%2F24
