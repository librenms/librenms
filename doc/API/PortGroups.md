...
```curl
curl -H 'Authorization: Bearer YOURAPITOKENHERE' https://foo.example/api/v0/portgroups/transit,peering
```
...
```curl
curl -H 'Authorization: Bearer YOURAPITOKENHERE' https://foo.example/api/v0/portgroups/multiport/bits/1,2,3
```
