...
```curl
curl -H 'Authorization: Bearer YOURAPITOKENHERE' https://foo.example/api/v0/bills
curl -H 'Authorization: Bearer YOURAPITOKENHERE' https://foo.example/api/v0/bills?period=previous
```
...
```curl
curl -H 'Authorization: Bearer YOURAPITOKENHERE' https://foo.example/api/v0/bills/1
curl -H 'Authorization: Bearer YOURAPITOKENHERE' https://foo.example/api/v0/bills?ref=:customerref
curl -H 'Authorization: Bearer YOURAPITOKENHERE' https://foo.example/api/v0/bills?custid=:custid
```
...
```curl
curl -H 'Authorization: Bearer YOURAPITOKENHERE' https://foo.example/api/v0/bills/1/graphs/bits
...
```curl
curl -H 'Authorization: Bearer YOURAPITOKENHERE' https://foo.example/api/v0/bills/1/graphdata/bits
curl -H 'Authorization: Bearer YOURAPITOKENHERE' https://foo.example/api/v0/bills/1/graphdata/bits?from=1517443200
curl -H 'Authorization: Bearer YOURAPITOKENHERE' https://foo.example/api/v0/bills/1/graphdata/bits?from=1517443200&to=1517788800
curl -H 'Authorization: Bearer YOURAPITOKENHERE' https://foo.example/api/v0/bills/1/graphdata/bits?from=1517443200&to=1517788800&reducefactor=5
```
...
```curl
curl -H 'Authorization: Bearer YOURAPITOKENHERE' https://foo.example/api/v0/bills/1/history
```
...
```curl
curl -H 'Authorization: Bearer YOURAPITOKENHERE' https://foo.example/api/v0/bills/1/history/1/graphs/bits
curl -H 'Authorization: Bearer YOURAPITOKENHERE' https://foo.example/api/v0/bills/1/history/1/graphs/hour
curl -H 'Authorization: Bearer YOURAPITOKENHERE' https://foo.example/api/v0/bills/1/history/1/graphs/day
```
...
```curl
curl -H 'Authorization: Bearer YOURAPITOKENHERE' https://foo.example/api/v0/bills/1/history/1/graphdata/bits
curl -H 'Authorization: Bearer YOURAPITOKENHERE' https://foo.example/api/v0/bills/1/history/1/graphdata/hour
curl -H 'Authorization: Bearer YOURAPITOKENHERE' https://foo.example/api/v0/bills/1/history/1/graphdata/day
```
...
```curl
curl -X DELETE -H 'Authorization: Bearer YOURAPITOKENHERE' https://foo.example/api/v0/bills/1
```
...
```curl
curl -X POST -d '{"ports":[ 1021 ],"bill_name":"NEWBILL","bill_day":"1","bill_type":"quota","bill_quota":"2000000000000","bill_custid":"1337","bill_ref":"reference1","bill_notes":"mynote"}' -H 'Authorization: Bearer YOURAPITOKENHERE' https://foo.example/api/v0/bills
```

Example (set):

```curl
curl -X POST -d '{"bill_id":"32","ports":[ 1021 ],"bill_name":"NEWNAME","bill_quota":"1000000000000"}' -H 'Authorization: Bearer YOURAPITOKENHERE' https://foo.example/api/v0/bills
```
