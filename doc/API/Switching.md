...
Get a list of all ports NAC with human readable device and interface names.

Route: `/api/v0/resources/nac/:mac/detail`
...
Example:
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://librenms.org/api/v0/resources/nac/1aaa2bbb3ccc/detail
```
...
```json
{
    ...
    "ports_nac": [
        {
            "hostname": "switchname.librenms.org",
            "ifName": "Gi0\/7",
            "updated_at": "2025-05-08T11:05:06.000000Z",
            "last_seen": "20 hours ago"
        },
        {
            "hostname": "switchname.librenms.org",
            "ifName": "Gi0\/7",
            "updated_at": "2025-05-08T08:55:06.000000Z",
            "last_seen": "23 hours ago"
        }
    ],
    "count": 2,
    "mac": "1a:aa:2b:bb:3c:cc",
    "mac_oui": ""
}
```
