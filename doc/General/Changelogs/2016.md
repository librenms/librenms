...
* Improve ALPHABRIDGE detection ([#4329](https://github.com/librenms/librenms/issues/4329))
...
#### Improvements
  - Added / improved detection for:
    ...
    - ALPHABRIDGE support ([PR3459](https://github.com/librenms/librenms/pull/3459))
