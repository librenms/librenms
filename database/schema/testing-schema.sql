...
CREATE TABLE `ospfv3_areas` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `device_id` int(10) unsigned NOT NULL,
  `ospfv3AreaId` varchar(32) NOT NULL,
  `ospfv3AreaImportAsExtern` varchar(128) NOT NULL,
  `ospfv3AreaSpfRuns` int(11) NOT NULL,
  `ospfv3AreaBdrRtrCount` int(11) NOT NULL,
  `ospfv3AreaAsBdrRtrCount` int(11) NOT NULL,
  `ospfv3AreaScopeLsaCount` int(11) NOT NULL,
  `ospfv3AreaScopeLsaCksumSum` int(11) NOT NULL,
  `ospfv3AreaSummary` varchar(64) NOT NULL,
  `ospfv3AreaStubMetric` varchar(64) NOT NULL,
  `ospfv3AreaStubMetricType` varchar(64) NOT NULL,
  `context_name` varchar(128) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `ospfv3_instances` (
  ...
  `ospfv3RouterId` varchar(32) NOT NULL,
  ...
  `ospfv3ExtLsaCount` int(11) NOT NULL,
  `ospfv3OriginateNewLsas` int(11) NOT NULL,
  `ospfv3RxNewLsas` int(11) NOT NULL,
...
CREATE TABLE `ospfv3_nbrs` (
  ...
  `device_id` int(10) unsigned NOT NULL,
  `port_id` int(10) unsigned DEFAULT NULL,
  `ospfv3_nbr_id` varchar(32) NOT NULL,
  `ospfv3NbrIfId` int(11) NOT NULL,
  `ospfv3NbrIfIndex` int(11) NOT NULL,
  `ospfv3NbrIfInstId` int(11) NOT NULL,
  `ospfv3NbrAddressType` varchar(32) NOT NULL,
  `ospfv3NbrAddress` varchar(39) NOT NULL,
  `ospfv3NbrRtrId` varchar(32) NOT NULL,
  `ospfv3NbrOptions` int(11) NOT NULL,
  `ospfv3NbrPriority` int(11) NOT NULL,
  `ospfv3NbrState` varchar(32) NOT NULL,
  `ospfv3NbrEvents` int(11) NOT NULL,
  `ospfv3NbrLsRetransQLen` int(11) NOT NULL,
  `ospfv3NbrHelloSuppressed` varchar(32) NOT NULL,
  `context_name` varchar(128) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `ospfv3_nbrs_device_id_ospfv3_nbr_id_context_name_unique` (`device_id`,`ospfv3_nbr_id`,`context_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ospfv3_ports` (
  ...
  `device_id` int(10) unsigned NOT NULL,
  `port_id` int(10) unsigned NOT NULL,
  `ospfv3_port_id` varchar(32) NOT NULL,
  `ospfv3IfIndex` int(11) NOT NULL,
  `ospfv3IfInstId` int(11) DEFAULT NULL,
  `ospfv3IfAreaId` varchar(32) NOT NULL,
  `ospfv3IfType` varchar(32) DEFAULT NULL,
  `ospfv3IfAdminStatus` varchar(32) DEFAULT NULL,
  `ospfv3IfRtrPriority` int(11) DEFAULT NULL,
  `ospfv3IfTransitDelay` int(11) DEFAULT NULL,
  `ospfv3IfRetransInterval` int(11) DEFAULT NULL,
  `ospfv3IfHelloInterval` int(11) DEFAULT NULL,
  `ospfv3IfRtrDeadInterval` int(11) DEFAULT NULL,
  `ospfv3IfPollInterval` int(11) DEFAULT NULL,
