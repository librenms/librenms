...
CREATE TABLE `device_group_device` (
  ...
  CONSTRAINT `device_group_device_device_group_id_foreign` FOREIGN KEY (`device_group_id`) REFERENCES `device_groups` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `device_group_device_device_id_foreign` FOREIGN KEY (`device_id`) REFERENCES `devices` (`device_id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `device_relationships` (
  ...
  CONSTRAINT `device_relationship_child_device_id_fk` FOREIGN KEY (`child_device_id`) REFERENCES `devices` (`device_id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `device_relationship_parent_device_id_fk` FOREIGN KEY (`parent_device_id`) REFERENCES `devices` (`device_id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ipv4_addresses` (
  ...
  `ipv4_network_id` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `port_id` int unsigned NOT NULL,
  `context_name` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `sensors` (
  ...
  CONSTRAINT `sensors_device_id_foreign` FOREIGN KEY (`device_id`) REFERENCES `devices` (`device_id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sensors_to_state_indexes` (
  ...
  CONSTRAINT `sensors_to_state_indexes_ibfk_1` FOREIGN KEY (`state_index_id`) REFERENCES `state_indexes` (`state_index_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `sensors_to_state_indexes_sensor_id_foreign` FOREIGN KEY (`sensor_id`) REFERENCES `sensors` (`sensor_id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `service_templates_device` (
  ...
  CONSTRAINT `service_templates_device_device_id_foreign` FOREIGN KEY (`device_id`) REFERENCES `devices` (`device_id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `service_templates_device_service_template_id_foreign` FOREIGN KEY (`service_template_id`) REFERENCES `service_templates` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `service_templates_device_group` (
  ...
  CONSTRAINT `service_templates_device_group_device_group_id_foreign` FOREIGN KEY (`device_group_id`) REFERENCES `device_groups` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `service_templates_device_group_service_template_id_foreign` FOREIGN KEY (`service_template_id`) REFERENCES `service_templates` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `wireless_sensors` (
  ...
  CONSTRAINT `wireless_sensors_device_id_foreign` FOREIGN KEY (`device_id`) REFERENCES `devices` (`device_id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (2,'2018_07_03_091314_create_alert_device_map_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (3,'2018_07_03_091314_create_alert_group_map_table',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (4,'2018_07_03_091314_create_alert_log_table',4);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (5,'2018_07_03_091314_create_alert_rules_table',5);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2018_07_03_091314_create_alert_schedulables_table',6);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (7,'2018_07_03_091314_create_alert_schedule_table',7);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (8,'2018_07_03_091314_create_alert_template_map_table',8);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (9,'2018_07_03_091314_create_alert_templates_table',9);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (10,'2018_07_03_091314_create_alert_transport_groups_table',10);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (11,'2018_07_03_091314_create_alert_transport_map_table',11);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (12,'2018_07_03_091314_create_alert_transports_table',12);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (13,'2018_07_03_091314_create_alerts_table',13);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (14,'2018_07_03_091314_create_api_tokens_table',14);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (15,'2018_07_03_091314_create_application_metrics_table',15);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (16,'2018_07_03_091314_create_applications_table',16);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (17,'2018_07_03_091314_create_authlog_table',17);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (18,'2018_07_03_091314_create_bgpPeers_cbgp_table',18);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (19,'2018_07_03_091314_create_bgpPeers_table',19);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (20,'2018_07_03_091314_create_bill_data_table',20);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (21,'2018_07_03_091314_create_bill_history_table',21);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (22,'2018_07_03_091314_create_bill_perms_table',22);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (23,'2018_07_03_091314_create_bill_port_counters_table',23);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (24,'2018_07_03_091314_create_bill_ports_table',24);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (25,'2018_07_03_091314_create_bills_table',25);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (26,'2018_07_03_091314_create_callback_table',26);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (27,'2018_07_03_091314_create_cef_switching_table',27);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (28,'2018_07_03_091314_create_ciscoASA_table',28);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (29,'2018_07_03_091314_create_component_prefs_table',29);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (30,'2018_07_03_091314_create_component_statuslog_table',30);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (31,'2018_07_03_091314_create_component_table',31);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (32,'2018_07_03_091314_create_config_table',32);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (33,'2018_07_03_091314_create_customers_table',33);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (34,'2018_07_03_091314_create_dashboards_table',34);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (35,'2018_07_03_091314_create_dbSchema_table',35);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (36,'2018_07_03_091314_create_device_graphs_table',36);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (37,'2018_07_03_091314_create_device_group_device_table',37);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (38,'2018_07_03_091314_create_device_groups_table',38);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (39,'2018_07_03_091314_create_device_mibs_table',39);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (40,'2018_07_03_091314_create_device_oids_table',40);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (41,'2018_07_03_091314_create_device_perf_table',41);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (42,'2018_07_03_091314_create_device_relationships_table',42);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (43,'2018_07_03_091314_create_devices_attribs_table',43);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (44,'2018_07_03_091314_create_devices_perms_table',44);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (45,'2018_07_03_091314_create_devices_table',45);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (46,'2018_07_03_091314_create_entPhysical_state_table',46);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (47,'2018_07_03_091314_create_entPhysical_table',47);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (48,'2018_07_03_091314_create_entityState_table',48);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (49,'2018_07_03_091314_create_eventlog_table',49);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (50,'2018_07_03_091314_create_graph_types_table',50);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (51,'2018_07_03_091314_create_hrDevice_table',51);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (52,'2018_07_03_091314_create_ipsec_tunnels_table',52);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (53,'2018_07_03_091314_create_ipv4_addresses_table',53);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (54,'2018_07_03_091314_create_ipv4_mac_table',54);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (55,'2018_07_03_091314_create_ipv4_networks_table',55);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (56,'2018_07_03_091314_create_ipv6_addresses_table',56);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (57,'2018_07_03_091314_create_ipv6_networks_table',57);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (58,'2018_07_03_091314_create_juniAtmVp_table',58);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (59,'2018_07_03_091314_create_links_table',59);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (60,'2018_07_03_091314_create_loadbalancer_rservers_table',60);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (61,'2018_07_03_091314_create_loadbalancer_vservers_table',61);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (62,'2018_07_03_091314_create_locations_table',62);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (63,'2018_07_03_091314_create_mac_accounting_table',63);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (64,'2018_07_03_091314_create_mefinfo_table',64);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (65,'2018_07_03_091314_create_mempools_table',65);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (66,'2018_07_03_091314_create_mibdefs_table',66);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (67,'2018_07_03_091314_create_munin_plugins_ds_table',67);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (68,'2018_07_03_091314_create_munin_plugins_table',68);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (69,'2018_07_03_091314_create_netscaler_vservers_table',69);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (70,'2018_07_03_091314_create_notifications_attribs_table',70);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (71,'2018_07_03_091314_create_notifications_table',71);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (72,'2018_07_03_091314_create_ospf_areas_table',72);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (73,'2018_07_03_091314_create_ospf_instances_table',73);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (74,'2018_07_03_091314_create_ospf_nbrs_table',74);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (75,'2018_07_03_091314_create_ospf_ports_table',75);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (76,'2018_07_03_091314_create_packages_table',76);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (77,'2018_07_03_091314_create_pdb_ix_peers_table',77);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (78,'2018_07_03_091314_create_pdb_ix_table',78);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (79,'2018_07_03_091314_create_perf_times_table',79);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (80,'2018_07_03_091314_create_plugins_table',80);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (81,'2018_07_03_091314_create_poller_cluster_stats_table',81);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (82,'2018_07_03_091314_create_poller_cluster_table',82);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (83,'2018_07_03_091314_create_poller_groups_table',83);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (84,'2018_07_03_091314_create_pollers_table',84);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (85,'2018_07_03_091314_create_ports_adsl_table',85);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (86,'2018_07_03_091314_create_ports_fdb_table',86);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (87,'2018_07_03_091314_create_ports_nac_table',87);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (88,'2018_07_03_091314_create_ports_perms_table',88);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (89,'2018_07_03_091314_create_ports_stack_table',89);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (90,'2018_07_03_091314_create_ports_statistics_table',90);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (91,'2018_07_03_091314_create_ports_stp_table',91);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (92,'2018_07_03_091314_create_ports_table',92);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (93,'2018_07_03_091314_create_ports_vlans_table',93);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (94,'2018_07_03_091314_create_processes_table',94);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (95,'2018_07_03_091314_create_processors_table',95);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (96,'2018_07_03_091314_create_proxmox_ports_table',96);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (97,'2018_07_03_091314_create_proxmox_table',97);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (98,'2018_07_03_091314_create_pseudowires_table',98);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (99,'2018_07_03_091314_create_route_table',99);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (100,'2018_07_03_091314_create_sensors_table',100);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (101,'2018_07_03_091314_create_sensors_to_state_indexes_table',101);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (102,'2018_07_03_091314_create_services_table',102);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (103,'2018_07_03_091314_create_session_table',103);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (104,'2018_07_03_091314_create_slas_table',104);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (105,'2018_07_03_091314_create_state_indexes_table',105);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (106,'2018_07_03_091314_create_state_translations_table',106);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (107,'2018_07_03_091314_create_storage_table',107);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (108,'2018_07_03_091314_create_stp_table',108);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (109,'2018_07_03_091314_create_syslog_table',109);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (110,'2018_07_03_091314_create_tnmsneinfo_table',110);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (111,'2018_07_03_091314_create_toner_table',111);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (112,'2018_07_03_091314_create_transport_group_transport_table',112);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (113,'2018_07_03_091314_create_ucd_diskio_table',113);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (114,'2018_07_03_091314_create_users_prefs_table',114);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (115,'2018_07_03_091314_create_users_table',115);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (116,'2018_07_03_091314_create_users_widgets_table',116);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (117,'2018_07_03_091314_create_vlans_table',117);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (118,'2018_07_03_091314_create_vminfo_table',118);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (119,'2018_07_03_091314_create_vrf_lite_cisco_table',119);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (120,'2018_07_03_091314_create_vrfs_table',120);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (121,'2018_07_03_091314_create_widgets_table',121);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (122,'2018_07_03_091314_create_wireless_sensors_table',122);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (123,'2018_07_03_091322_add_foreign_keys_to_component_prefs_table',123);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (124,'2018_07_03_091322_add_foreign_keys_to_component_statuslog_table',124);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (125,'2018_07_03_091322_add_foreign_keys_to_device_group_device_table',125);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (126,'2018_07_03_091322_add_foreign_keys_to_device_relationships_table',126);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (127,'2018_07_03_091322_add_foreign_keys_to_sensors_table',127);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (128,'2018_07_03_091322_add_foreign_keys_to_sensors_to_state_indexes_table',128);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (129,'2018_07_03_091322_add_foreign_keys_to_wireless_sensors_table',129);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (130,'2019_01_16_132200_add_vlan_and_elapsed_to_nac',130);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (131,'2019_01_16_195644_add_vrf_id_and_bgpLocalAs',131);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (132,'2019_02_05_140857_remove_config_definition_from_db',132);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (133,'2019_02_10_220000_add_dates_to_fdb',133);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (134,'2019_04_22_220000_update_route_table',134);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (135,'2019_05_12_202407_create_mpls_lsps_table',135);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (136,'2019_05_12_202408_create_mpls_lsp_paths_table',136);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (137,'2019_05_30_225937_device_groups_rewrite',137);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (138,'2019_06_30_190400_create_mpls_sdps_table',138);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (139,'2019_06_30_190401_create_mpls_sdp_binds_table',139);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (140,'2019_06_30_190402_create_mpls_services_table',140);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (141,'2019_07_03_132417_create_mpls_saps_table',141);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (142,'2019_07_09_150217_update_users_widgets_settings',142);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (143,'2019_08_10_223200_add_enabled_to_users',143);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (144,'2019_08_28_105051_fix-template-linefeeds',144);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (145,'2019_09_05_153524_create_notifications_attribs_index',145);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (146,'2019_09_29_114433_change_default_mempool_perc_warn_in_mempools_table',146);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (147,'2019_10_03_211702_serialize_config',147);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (148,'2019_10_21_105350_devices_group_perms',148);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (149,'2019_11_30_191013_create_mpls_tunnel_ar_hops_table',149);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (150,'2019_11_30_191013_create_mpls_tunnel_c_hops_table',150);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (151,'2019_12_01_165514_add_indexes_to_mpls_lsp_paths_table',151);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (152,'2019_12_05_164700_alerts_disable_on_update_current_timestamp',152);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (153,'2019_12_16_140000_create_customoids_table',153);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (154,'2019_12_17_151314_add_invert_map_to_alert_rules',154);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (155,'2019_12_28_180000_add_overwrite_ip_to_devices',155);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (156,'2020_01_09_1300_migrate_devices_attribs_table',156);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (157,'2020_01_10_075852_alter_mpls_lsp_paths_table',157);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (158,'2020_02_05_093457_add_inserted_to_devices',158);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (159,'2020_02_05_224042_device_inserted_null',159);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (160,'2020_02_10_223323_create_alert_location_map_table',160);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (161,'2020_03_24_0844_add_primary_key_to_device_graphs',161);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (162,'2020_03_25_165300_add_column_to_ports',162);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (163,'2020_04_06_001048_the_great_index_rename',163);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (164,'2020_04_08_172357_alert_schedule_utc',164);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (165,'2020_04_13_150500_add_last_error_fields_to_bgp_peers',165);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (166,'2020_04_19_010532_eventlog_sensor_reference_cleanup',166);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (167,'2020_05_22_020303_alter_metric_column',167);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (168,'2020_05_24_212054_poller_cluster_settings',168);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (169,'2020_05_30_162638_remove_mib_polling_tables',169);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (170,'2020_06_06_222222_create_device_outages_table',170);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (171,'2020_06_23_00522_alter_availability_perc_column',171);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (172,'2020_06_24_155119_drop_ports_if_high_speed',172);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (173,'2020_07_27_00522_alter_devices_snmp_algo_columns',173);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (174,'2020_07_29_143221_add_device_perf_index',174);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (175,'2020_08_28_212054_drop_uptime_column_outages',175);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (176,'2020_09_18_223431_create_cache_table',176);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (177,'2020_09_18_230114_create_service_templates_device_group_table',177);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (178,'2020_09_18_230114_create_service_templates_device_table',178);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (179,'2020_09_18_230114_create_service_templates_table',179);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (180,'2020_09_18_230114_extend_services_table_for_service_templates_table',180);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (181,'2020_09_19_230114_add_foreign_keys_to_service_templates_device_group_table',181);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (182,'2020_09_19_230114_add_foreign_keys_to_service_templates_device_table',182);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (183,'2020_09_22_172321_add_alert_log_index',183);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (184,'2020_09_24_000500_create_cache_locks_table',184);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (185,'2020_10_03_1000_add_primary_key_bill_perms',185);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (186,'2020_10_03_1000_add_primary_key_bill_ports',186);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (187,'2020_10_03_1000_add_primary_key_devices_perms',187);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (188,'2020_10_03_1000_add_primary_key_entPhysical_state',188);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (189,'2020_10_03_1000_add_primary_key_ipv4_mac',189);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (190,'2020_10_03_1000_add_primary_key_juniAtmVp',190);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (191,'2020_10_03_1000_add_primary_key_loadbalancer_vservers',191);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (192,'2020_10_03_1000_add_primary_key_ports_perms',192);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (193,'2020_10_03_1000_add_primary_key_processes',193);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (194,'2020_10_03_1000_add_primary_key_transport_group_transport',194);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (195,'2020_10_12_095504_mempools_add_oids',195);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (196,'2020_10_21_124101_allow_nullable_ospf_columns',196);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (197,'2020_10_30_093601_add_tos_to_ospf_ports',197);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (198,'2020_11_02_164331_add_powerstate_enum_to_vminfo',198);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (199,'2020_12_14_091314_create_port_group_port_table',199);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (200,'2020_12_14_091314_create_port_groups_table',200);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (201,'2021_02_08_224355_fix_invalid_dates',201);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (202,'2021_02_09_084318_remove_perf_times',202);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (203,'2021_02_09_122930_migrate_to_utf8mb4',203);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (204,'2021_02_21_203415_location_add_fixed_coordinates_flag',204);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (205,'2021_03_11_003540_rename_toner_table',205);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (206,'2021_03_11_003713_rename_printer_columns',206);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (207,'2021_03_17_160729_service_templates_cleanup',207);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (208,'2021_03_26_014054_change_cache_to_mediumtext',208);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (209,'2021_04_08_151101_add_foreign_keys_to_port_group_port_table',209);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (210,'2021_06_07_123600_create_sessions_table',210);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (211,'2021_06_11_084830_slas_add_rtt_field',211);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (212,'2021_07_06_1845_alter_bill_history_max_min',212);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (213,'2021_07_28_102443_plugins_add_version_and_settings',213);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (214,'2021_08_04_102914_add_syslog_indexes',214);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (215,'2021_08_26_093522_config_value_to_medium_text',215);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (216,'2021_09_07_094310_create_push_subscriptions_table',216);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (217,'2021_09_26_164200_create_hrsystem_table',217);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (218,'2021_10_02_190310_add_device_outages_index',218);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (219,'2021_10_03_164200_update_hrsystem_table',219);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (220,'2021_10_20_072929_disable_example_plugin',220);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (221,'2021_10_20_224207_increase_length_of_attrib_type_column',221);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (222,'2021_11_12_123037_change_cpwVcID_to_unsignedInteger',222);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (223,'2021_11_17_105321_device_add_display_field',223);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (224,'2021_11_29_160744_change_ports_text_fields_to_varchar',224);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (225,'2021_11_29_165046_improve_devices_search_index',225);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (226,'2021_11_29_165436_improve_ports_search_index',226);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (227,'2021_12_02_100709_remove_ports_stp_unique_index',227);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (228,'2021_12_02_101739_add_vlan_field_to_stp_table',228);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (229,'2021_12_02_101810_add_vlan_and_port_index_fields_to_ports_stp_table',229);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (230,'2021_12_02_110154_update_ports_stp_unique_index',230);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (231,'2021_12_02_113537_ports_stp_designated_cost_change_to_int',231);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (232,'2021_25_01_0127_create_isis_adjacencies_table',232);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (233,'2021_25_01_0128_isis_adjacencies_add_admin_status',233);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (234,'2021_25_01_0129_isis_adjacencies_nullable',234);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (235,'2022_02_03_164059_increase_auth_id_length',235);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (236,'2022_02_21_073500_add_iface_field_to_bgp_peers',236);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (237,'2022_04_08_085504_isis_adjacencies_table_add_index',237);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (238,'2022_05_25_084506_add_widgets_column_to_users_widgets_table',238);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (239,'2022_05_25_084617_migrate_widget_ids',239);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (240,'2022_05_25_085715_remove_user_widgets_id',240);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (241,'2022_05_25_090027_drop_widgets_table',241);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (242,'2022_05_30_084932_update-app-status-length',242);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (243,'2022_07_03_1947_add_app_data',243);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (244,'2022_07_19_081224_plugins_unique_index',244);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (245,'2022_08_15_084506_add_rrd_type_to_sensors_table',245);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (246,'2022_08_15_084507_add_rrd_type_to_wireless_sensors_table',246);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (247,'2022_08_15_091314_create_ports_vdsl_table',247);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (248,'2022_09_03_091314_update_ports_adsl_table_with_defaults',248);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (249,'2023_03_14_130653_migrate_empty_user_funcs_to_null',249);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (250,'2023_04_12_174529_modify_ports_table',250);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (251,'2023_04_26_185850_change_vminfo_vmw_vm_guest_o_s_nullable',251);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (252,'2023_04_27_164904_update_slas_opstatus_tinyint',252);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (253,'2023_05_12_071412_devices_expand_timetaken_doubles',253);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (254,'2023_06_02_230406_create_vendor_oui_table',254);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (255,'2023_06_18_195618_create_bouncer_tables',255);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (256,'2023_06_18_201914_migrate_level_to_roles',256);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (257,'2023_08_02_090027_drop_dbschema_table',257);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (258,'2023_08_02_120455_vendor_ouis_unique_index',258);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (259,'2023_08_30_105156_add_applications_soft_deleted',259);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (260,'2023_09_01_084057_application_new_defaults',260);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (261,'2023_10_07_170735_increase_processes_cputime_length',261);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (262,'2023_10_07_231037_application_metrics_add_primary_key',262);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (263,'2023_10_12_183306_ports_statistics_table_unsigned_stats',263);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (264,'2023_10_12_184311_bgp_peers_cbgp_table_unsigned_stats',264);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (265,'2023_10_12_184652_bgp_peers_table_unsigned_stats',265);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (266,'2023_10_14_162039_restore_ports_delta_fields',266);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (267,'2023_10_14_162234_restore_bgp_peers_cbgp_delta_fields',267);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (268,'2023_10_20_075853_cisco_asa_add_default_limits',268);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (269,'2023_10_31_074547_ospf_areas_unsigned',269);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (270,'2023_10_31_074901_ospf_instances_unsigned',270);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (271,'2023_10_31_075239_ospf_nbrs_unsigned',271);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (272,'2023_10_31_080052_ospf_ports_unsigned',272);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (273,'2023_11_04_125846_packages_increase_name_column_length',273);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (274,'2023_11_21_172239_increase_vminfo.vmwvmguestos_column_length',274);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (275,'2023_12_08_080319_create_custom_map_table',275);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (276,'2023_12_08_081420_create_custom_map_node_table',276);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (277,'2023_12_08_082518_create_custom_map_edge_table',277);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (278,'2023_12_08_083319_create_custom_map_background_table',278);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (279,'2023_12_08_184652_mpls_addrtype_fix',279);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (280,'2023_12_10_130000_historical_data_to_ports_nac',280);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (281,'2023_12_12_171400_alert_rule_note',281);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (282,'2023_12_15_105529_access_points_nummonbssid_integer',282);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (283,'2023_12_19_082112_custom_map_grid_snap',283);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (285,'2024_01_04_195618_add_ignore_status_to_devices_tables',285);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (286,'2024_01_08_223812_custom_map_node_image',286);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (287,'2024_01_09_211518_custom_map_node_maplink',287);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (288,'2024_01_09_223917_bill_data_new_primary',288);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (289,'2024_01_09_223927_bill_data_updated_indexes',289);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (290,'2024_02_03_201014_custom_map_edge_additions',290);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (291,'2024_02_07_151845_custom_map_additions',291);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (292,'2024_03_27_123152_create_transceivers_table',292);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (293,'2024_04_10_093513_remove_device_perf',293);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (294,'2024_04_22_161711_custom_maps_add_group',294);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (295,'2024_04_29_180911_custom_maps_add_background_type_and_background_data',295);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (296,'2024_04_29_183605_custom_maps_drop_background_suffix_and_background_version',296);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (297,'2024_07_13_133839_modify_ent_physical_defaults',297);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (298,'2024_07_19_120719_update_ports_stack_table',298);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (299,'2024_07_28_162410_ent_physical_table_ifindex_unsigned',299);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (300,'2024_08_12_232009_ent_physical_table_rev_length',300);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (301,'2024_08_27_182000_ports_statistics_table_rev_length',301);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (302,'2024_10_06_002633_ports_vlans_table_add_port_id_index',302);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (303,'2024_10_12_164214_custom_map_edge_width',303);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (304,'2024_10_12_210114_custom_map_legend_colours',304);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (305,'2024_10_13_161616_create_custom_map_nodeimage_table',305);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (306,'2024_10_13_162920_add_custom_map_nodeimage_column',306);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (307,'2024_10_20_154356_create_qos_table',307);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (308,'2024_10_24_131715_mpls_sdp_bindings_enum_string',308);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (309,'2024_11_07_110342_custommap_edge_add_text_align',309);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (310,'2024_11_22_135845_alert_log_refactor_indexes',310);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (311,'2025_01_07_223946_drop_cisco_a_s_a_table',311);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (312,'2025_01_20_125000_create_ospfv3_areas_table',312);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (313,'2025_01_20_125000_create_ospfv3_instances_table',313);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (314,'2025_01_20_125000_create_ospfv3_nbrs_table',314);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (315,'2025_01_20_125000_create_ospfv3_ports_table',315);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (316,'2025_01_22_194300_add_storage_oids_to_storage_table',316);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (317,'2025_01_22_194342_drop_storage_deleted',317);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (318,'2025_01_28_135558_ports_drop_unique_ifindex',318);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (319,'2025_01_30_000121_add_ifindex_index_to_ports_table',319);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (320,'2025_01_30_214311_create_ipv6_nd_table',320);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (321,'2025_03_11_031114_drop_ospfv3ifinstid',321);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (322,'2025_03_17_144000_drop_ospfv3nbrifindex',322);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (323,'2025_03_17_222255_rename_existing_permissions_tables',323);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (324,'2025_03_17_222652_create_permission_tables',324);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (325,'2025_03_17_222734_migrate_bouncer_to_spatie',325);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (326,'2025_03_18_003446_drop_bouncer_tables',326);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (327,'2025_03_19_205644_fix_ospfv3_areas_table',327);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (328,'2025_03_19_205648_fix_ospfv3_instances_table',328);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (329,'2025_03_19_205655_fix_ospfv3_nbrs_table',329);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (330,'2025_03_19_205700_fix_ospfv3_ports_table',330);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (331,'2025_03_22_134124_fix_ipv6_addresses_id_type',331);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (332,'2025_04_15_122034_laravel_11_fix_types',332);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (333,'2025_04_29_133233_add_device_index_to_ipv4_mac_table',333);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (334,'2025_04_29_133533_add_indexes_to_ipv6_nd_table',334);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (335,'2025_04_29_150404_context_nullable_in_ipv4_mac_table',335);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (336,'2025_04_29_150423_context_nullable_in_ipv6_nd_table',336);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (337,'2025_05_02_133959_filter_empty_socialite_configs',337);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (338,'2025_05_03_152418_remove_invalid_sensor_classes',338);
