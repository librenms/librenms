...
CREATE TABLE device_groups (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) DEFAULT '' NOT NULL COLLATE "BINARY", "desc" VARCHAR(255) DEFAULT '' NOT NULL COLLATE "BINARY", type VARCHAR(16) DEFAULT 'dynamic' NOT NULL COLLATE "BINARY", pattern CLOB DEFAULT NULL COLLATE "BINARY");
