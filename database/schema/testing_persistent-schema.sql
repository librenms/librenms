...
CREATE TABLE slas (sla_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, device_id INTEGER NOT NULL, owner VARCHAR(255) NOT NULL COLLATE "BINARY", tag VARCHAR(255) NOT NULL COLLATE "BINARY", rtt_type VARCHAR(255) NOT NULL COLLATE "BINARY", status BOOLEAN NOT NULL, deleted BOOLEAN DEFAULT 0 NOT NULL, sla_nr INTEGER UNSIGNED NOT NULL, rtt DOUBLE PRECISION DEFAULT NULL, opstatus INTEGER DEFAULT 0 NOT NULL);
...
INSERT INTO migrations VALUES(249,'2023_03_14_130653_migrate_empty_user_funcs_to_null',2);
INSERT INTO migrations VALUES(250,'2023_04_12_174529_modify_ports_table',2);
INSERT INTO migrations VALUES(251,'2023_04_27_164904_update_slas_opstatus_tinyint',2);
INSERT INTO migrations VALUES(252,'2023_05_12_071412_devices_expand_timetaken_doubles',2);
