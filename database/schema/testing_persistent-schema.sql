...
CREATE TABLE ospfv3_areas (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, device_id INTEGER NOT NULL, ospfv3AreaId VARCHAR(255) NOT NULL,  ospfv3AreaImportAsExtern VARCHAR(255) NOT NULL, ospfv3AreaSpfRuns INTEGER UNSIGNED NOT NULL, ospfv3AreaBdrRtrCount INTEGER UNSIGNED NOT NULL, ospfv3AreaAsBdrRtrCount INTEGER UNSIGNED NOT NULL, ospfv3AreaScopeLsaCount INTEGER UNSIGNED NOT NULL, ospfv3AreaScopeLsaCksumSum INTEGER NOT NULL, ospfv3AreaSummary VARCHAR(255) NOT NULL, ospfv3AreaStubMetric VARCHAR(255) NOT NULL, ospfv3AreaStubMetricType VARCHAR(255) NOT NULL, context_name VARCHAR(255) DEFAULT NULL);
CREATE UNIQUE INDEX ospfv3_areas_device_id_ospfv3areaid_context_name_unique ON ospfv3_areas (device_id, ospfv3AreaId, context_name);
CREATE TABLE ospfv3_instances (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, device_id INTEGER NOT NULL, ospfv3_instance_id INTEGER NOT NULL, ospfv3RouterId VARCHAR(255) NOT NULL, ospfv3AdminStatus VARCHAR(255) NOT NULL, ospfv3VersionNumber VARCHAR(255) NOT NULL, ospfv3AreaBdrRtrStatus VARCHAR(255) NOT NULL, ospfv3ASBdrRtrStatus VARCHAR(255) NOT NULL, ospfv3ExternLsaCount INTEGER UNSIGNED NOT NULL, ospfv3OriginateNewLsas INTEGER UNSIGNED NOT NULL, ospfv3RxNewLsas INTEGER UNSIGNED NOT NULL, ospfv3ExtAreaLsdbLimit INTEGER DEFAULT NULL, ospfv3AsScopeLsaCount INTEGER DEFAULT NULL, ospfv3ExitOverflowInterval INTEGER DEFAULT NULL, ospfv3AsScopeLsaCksumSum context_name int(11) DEFAULT NULL,);
CREATE UNIQUE INDEX ospf3_instances_device_id_ospf3_instance_id_context_name_uniq ON ospfv3_instances (device_id, ospfv3_instance_id, context_name);
CREATE TABLE ospfv3_nbrs (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, device_id INTEGER NOT NULL, port_id INTEGER DEFAULT NULL, ospfv3_nbr_id VARCHAR(255) NOT NULL, ospfv3NbrIpAddr VARCHAR(255) NOT NULL, ospfv3NbrAddressLessIndex INTEGER NOT NULL, ospfv3NbrRtrId VARCHAR(255) NOT NULL, ospfv3NbrOptions INTEGER NOT NULL, ospfv3NbrPriority INTEGER NOT NULL, ospfv3NbrState VARCHAR(255) NOT NULL, ospfv3NbrEvents INTEGER UNSIGNED NOT NULL, ospfv3NbrLsRetransQLen INTEGER UNSIGNED NOT NULL, ospfv3NbrHelloSuppressed VARCHAR(255) NOT NULL, context_name VARCHAR(255) DEFAULT NULL);
CREATE UNIQUE INDEX ospfv3_nbrs_device_id_ospfv3_nbr_id_context_name_unique ON ospfv3_nbrs (device_id, ospfv3_nbr_id, context_name);
CREATE TABLE ospfv3_ports (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, device_id INTEGER NOT NULL, port_id INTEGER NOT NULL, ospfv3_port_id VARCHAR(255) NOT NULL, ospfv3IfIndex INTEGER DEFAULT NULL, ospfv3IfInstId INTEGER DEFAULT NULL, ospfv3IfAreaId VARCHAR(255) NOT NULL, ospfv3IfType VARCHAR(255) DEFAULT NULL, ospfv3IfAdminStatus VARCHAR(255) DEFAULT NULL, ospfv3IfRtrPriority INTEGER DEFAULT NULL, ospfv3IfTransitDelay INTEGER DEFAULT NULL, ospfv3IfRetransInterval INTEGER DEFAULT NULL, ospfv3IfHelloInterval INTEGER DEFAULT NULL, ospfv3IfRtrDeadInterval INTEGER DEFAULT NULL, ospfv3IfPollInterval INTEGER DEFAULT NULL, ospfv3IfState VARCHAR(255) DEFAULT NULL, ospfv3IfDesignatedRouter VARCHAR(255) DEFAULT NULL, ospfIfBackupDesignatedRouter VARCHAR(255) DEFAULT NULL, ospfv3IfEvents INTEGER UNSIGNED DEFAULT NULL, ospfv3IfDemand VARCHAR(255) DEFAULT NULL, ospfv3IfMetricValue INTEGER DEFAULT NULL, context_name VARCHAR(255) DEFAULT NULL);
CREATE UNIQUE INDEX ospfv3_ports_device_id_ospfv3_port_id_context_name_unique ON ospfv3_ports (device_id, ospfv3_port_id, context_name);
...
INSERT INTO migrations VALUES(297,'2025_01_20_125000_create_ospfv3_areas_table',1);
INSERT INTO migrations VALUES(298,'2025_01_20_125000_create_ospfv3_instances_table',1);
INSERT INTO migrations VALUES(299,'2025_01_20_125000_create_ospfv3_nbrs_table',1);
INSERT INTO migrations VALUES(300,'2025_01_20_125000_create_ospfv3_ports_table',1);
