...
Route::prefix('v0')->group(function () {
    ...
    Route::middleware(['can:global-read'])->group(function () {
        ...
        Route::prefix('resources')->group(function () {
            ...
            Route::get('ip/addresses', [\App\Api\Controllers\LegacyApiController::class, 'list_ip_addresses'])->name('list_ip_addresses');
            Route::get('ip/arp/{query}/{cidr?}', [\App\Api\Controllers\LegacyApiController::class, 'list_arp'])->name('list_arp');
            Route::get('ip/networks', [\App\Api\Controllers\LegacyApiController::class, 'list_ip_networks'])->name('list_ip_networks');
