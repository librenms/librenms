...
use App\Http\Controllers\DeviceLinkMapDataController;
...
use App\Http\Controllers\Maps\GeoMapDataController;
use App\Http\Controllers\Maps\MapDataController;
use App\Http\Controllers\Maps\ServicesMapDataController;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('maps')->namespace('Maps')->group(function () {
        ...
        Route::post('getdevices', [MapDataController::class, 'getDevices'])->name('maps.getdevices');
        Route::post('getdevicelinks', [DeviceLinkMapDataController::class, 'getDeviceLinks'])->name('maps.getdevicelinks');
        Route::post('getgeolinks', [GeoMapDataController::class, 'getGeographicLinks'])->name('maps.getgeolinks');
        Route::post('getservices', [ServicesMapDataController::class, 'getServices'])->name('maps.getservices');
    });
