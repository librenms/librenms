...
Route::group(['middleware' => ['auth'], 'guard' => 'auth'], function () {
    ...
    Route::prefix('services')->name('services.')->group(function () {
        ...
        Route::post('templates/{template}/remove', 'ServiceTemplateController@remove')->name('templates.remove');
        Route::post('templates/{template}/discover', 'ServiceTemplateController@discover')->name('templates.discover');
    });
