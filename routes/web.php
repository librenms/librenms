...
Route::middleware(['auth'])->group(function (): void {
    ...
    Route::prefix('ajax')->group(function (): void {
        ...
        Route::prefix('table')->group(function (): void {
            Route::any('address-search/ipv4', Table\Ipv4SearchController::class)->name('search.ipv4');
            Route::any('address-search/ipv6', Table\Ipv6SearchController::class)->name('search.ipv6');
