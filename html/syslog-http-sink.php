<?php
/**
 * LibreNMS Syslog Sink over HTTP from logstash (or any json format)
 *
 *   This file is part of LibreNMS.
 *
 * @copyright  (C) 2022 Stefan Grosser, based on a idea of syslog.php from Adam Armstrong
 */
$init_modules = [];
...
<h1>Syslog Sink</h1>
<p>This is a Info/Diag Page, please use HTTP POST method to submit logs<br/></br>
This Sink hole recieves multi array json data and stores it to the database.
<br/><br/>
