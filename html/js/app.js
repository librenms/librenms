        ...
        3460: (t, e, a) => {
            ...
            const n = {
                    ...
                    methods: {
                        ...
                        getUnits: function() {
                            var t = this.prefix + ".units." + this.setting.units;
                            return this.$te(t) ? this.$t(t) : this.setting.units
                        },
                        getDescription: function() {
                            var t = this.prefix + ".settings." + this.setting.name + ".description";
                            return this.$te(t) || this.$te(t, this.$i18n.fallbackLocale) ? this.$t(t) : this.setting.name
                        },
                        getHelp: function() {
                            var t = this.$t(this.prefix + ".settings." + this.setting.name + ".help");
                            return this.setting.overridden && (t += "</p><p>" + this.$t(this.prefix + ".readonly")), t
                        },
                        hasHelp: function() {
                            var t = this.prefix + ".settings." + this.setting.name + ".help";
                        ...
                        getRouteParams: function() {
                            var t = [this.setting.name];
                            return this.id && t.unshift(this.id), t
                        },
                        getComponent: function() {
                            var t = "Setting" + this.setting.type.toString().replace(/(-[a-z]|^[a-z])/g, (function(t) {
        ...
        2421: (t, e, a) => {
            ...
            const n = {
                ...
                data: function() {
                    var t;
                    return {
                        localList: null !== (t = this.value) && void 0 !== t ? t : new Object,
                        newSubItemKey: {},
                        newSubItemValue: {},
                        newSubArray: ""
                    }
                ...
                methods: {
                    addSubItem: function(t) {
                        if (!this.disabled) {
                            var e = {};
                            e[this.newSubItemKey[t]] = this.newSubItemValue[t], 0 === Object.keys(this.localList[t]).length && (this.localList[t] = new Object), Object.assign(this.localList[t], e), this.$emit("input", this.localList), this.newSubItemValue[t] = "", this.newSubItemKey[t] = ""
                        }
                    },
                    ...
                    addSubArray: function() {
                        this.disabled || (this.localList[this.newSubArray] = new Object, this.$emit("input", this.localList), this.newSubArray = "")
                    }
                },
                watch: {
                    value: function(t) {
        ...
        4088: (t, e, a) => {
            ...
            const n = {
                ...
                methods: {
                    ...
                    fillForm: function(t) {
                        var e = this.maps.hasOwnProperty(t);
                        ...
                        return Object.keys(this.value).forEach((function(a) {
                            Object.keys(t.value[a]).forEach((function(n) {
                                t.value[a][n].forEach((function(t) {
                                    var s = t.hasOwnProperty("regex") ? "regex" : "match";
                                    e.push({
                                        target: a,
                                        source: n,
                                        matchType: s,
            ...
            const n = {
                ...
                methods: {
                    getText: function(t, e) {
                        var a = "settings.settings.".concat(t, ".options.").concat(e);
