...
if ($config['enable_syslog']) {
    ...
    if (count($syslog)) {
        ...
        echo '<a href="device/device='.$device['device_id'].'/tab=logs/section=syslog/"><i class="fa fa-archive fa-lg icon-theme" aria-hidden="true"></i> <strong>Recent Syslog</strong></a>';
        echo '        </div>
