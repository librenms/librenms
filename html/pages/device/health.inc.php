...
$routing_resources  = dbFetchCell('select count(*) from routing_resources WHERE device_id = ?', array($device['device_id']));
...
if ($routing_resources) {
    $datas[] = 'routing_resources';
}
...
$type_text['routing_resources']    = 'Routing Resources';
