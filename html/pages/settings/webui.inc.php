...
echo generate_dynamic_config_panel('Graph settings', $config_groups, $graph_conf, true);
echo generate_dynamic_config_panel('Search settings', $config_groups, $search_conf, true);
