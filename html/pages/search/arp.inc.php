<div class="panel panel-default panel-condensed">
    ...
    <div id="arp-search-header" class="bootgrid-header container-fluid"><div class="row">
...
?>
                ...
                <div class="form-group">
                    <input type="text" name="searchPhrase" id="address" value="<?php echo $_POST['searchPhrase']; ?>" class="form-control input-sm" placeholder="Address" />
                </div>
