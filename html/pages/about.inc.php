...
echo "
        <td><i class='fa fa-server' style='color:".$config[theme_icon_colour]."' aria-hidden='true'></i> <b>Devices</b></td><td class='text-right'>$stat_devices</td>
        <td><i class='fa fa-link' style='color:".$config[theme_icon_colour]."' aria-hidden='true'></i> <b>Ports</b></td><td class='text-right'>$stat_ports</td>
      </tr>
      <tr>
        <td><i class='fa fa-battery-empty' style='color:".$config[theme_icon_colour]."' aria-hidden='true'></i> <b>IPv4 Addresses<b></td><td class='text-right'>$stat_ipv4_addy</td>
        <td><i class='fa fa-battery-empty' style='color:".$config[theme_icon_colour]."' aria-hidden='true'></i> <b>IPv4 Networks</b></td><td class='text-right'>$stat_ipv4_nets</td>
      </tr>
      <tr>
        <td><i class='fa fa-battery-full' style='color:".$config[theme_icon_colour]."' aria-hidden='true'></i> <b>IPv6 Addresses<b></td><td class='text-right'>$stat_ipv6_addy</td>
        <td><i class='fa fa-battery-full' style='color:".$config[theme_icon_colour]."' aria-hidden='true'></i> <b>IPv6 Networks</b></td><td class='text-right'>$stat_ipv6_nets</td>
       </tr>
     <tr>
        <td><i class='fa fa-cogs' style='color:".$config[theme_icon_colour]."' aria-hidden='true'></i> <b>Services<b></td><td class='text-right'>$stat_services</td>
        <td><i class='fa fa-cubes' style='color:".$config[theme_icon_colour]."' aria-hidden='true'></i> <b>Applications</b></td><td class='text-right'>$stat_apps</td>
      </tr>
      <tr>
        <td><i class='fa fa-microchip' style='color:".$config[theme_icon_colour]."' aria-hidden='true'></i> <b>Processors</b></td><td class='text-right'>$stat_processors</td>
        <td><i class='fa fa-braille' style='color:".$config[theme_icon_colour]."' aria-hidden='true'></i> <b>Memory</b></td><td class='text-right'>$stat_memory</td>
      </tr>
      <tr>
        <td><i class='fa fa-database' style='color:".$config[theme_icon_colour]."' aria-hidden='true'></i> <b>Storage</b></td><td class='text-right'>$stat_storage</td>
        <td><i class='fa fa-hdd-o' style='color:".$config[theme_icon_colour]."' aria-hidden='true'></i> <b>Disk I/O</b></td><td class='text-right'>$stat_diskio</td>
      </tr>
      <tr>
        <td><i class='fa fa-cube' style='color:".$config[theme_icon_colour]."' aria-hidden='true'></i> <b>HR-MIB</b></td><td class='text-right'>$stat_hrdev</td>
        <td><i class='fa fa-cube' style='color:".$config[theme_icon_colour]."' aria-hidden='true'></i> <b>Entity-MIB</b></td><td class='text-right'>$stat_entphys</td>
      </tr>
      <tr>
        <td><i class='fa fa-calendar-o' style='color:".$config[theme_icon_colour]."' aria-hidden='true'></i> <b>Syslog Entries</b></td><td class='text-right'>$stat_syslog</td>
        <td><i class='fa fa-calendar' style='color:".$config[theme_icon_colour]."' aria-hidden='true'></i> <b>Eventlog Entries</b></td><td class='text-right'>$stat_events</td>
      </tr>
      <tr>
        <td><i class='fa fa-dashboard' style='color:".$config[theme_icon_colour]."' aria-hidden='true'></i> <b>Sensors</b></td><td class='text-right'>$stat_sensors</td>
        <td><i class='fa fa-print' style='color:".$config[theme_icon_colour]."' aria-hidden='true'></i> <b>Toner</b></td><td class='text-right'>$stat_toner</td>
      </tr>
    </table>
</div>
";
