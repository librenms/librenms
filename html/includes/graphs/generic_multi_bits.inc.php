...
if ($i) {
    ...
    if ($legend == 'no' || $legend == '1') {
        $rrd_options .= ' AREA:inbits#' . $colour_area_in . $transparency . ':';
        $rrd_options .= ' LINE1.25:inbits#' . $colour_line_in . ':';
        $rrd_options .= ' AREA:doutbits#' . $colour_area_out . $transparency . ':';
    ...
    if ($_GET['previous'] == 'yes') {
        $rrd_options .= ' AREA:inbitsX#9999966' . $transparency . ':';
        $rrd_options .= ' AREA:doutbitsX#99999966' . $transparency . ':';
    }
}
