...
if ($i) {
    ...
    if ($legend == 'no' || $legend == '1') {
        $rrd_options .= ' AREA:inbits#' . $colour_area_in . generate_stacked_graphs()[0] . ':';
        $rrd_options .= ' LINE1.25:inbits#' . $colour_line_in . ':';
        $rrd_options .= ' AREA:doutbits#' . $colour_area_out . generate_stacked_graphs()[0] . ':';
    ...
    if ($_GET['previous'] == 'yes') {
        $rrd_options .= ' AREA:inbitsX#9999966' . generate_stacked_graphs()[0] . ':';
        $rrd_options .= ' AREA:doutbitsX#99999966' . generate_stacked_graphs()[0] . ':';
    }
}
