...
if (file_exists($rrdfilename)) {
    ...
    $rrd_options .= ' DEF:modemACMtotalCapacity='.$rrdfilename.':modemACMtotalCapacity:AVERAGE ';
    $rrd_options .= ' DEF:modemTotalCapacity='.$rrdfilename.':modemTotalCapacity:AVERAGE ';
    $rrd_options .= ' CDEF:acmCapacityMbps=modemACMtotalCapacity,1000,* ';
    $rrd_options .= ' CDEF:capacityMbps=modemTotalCapacity,1000,* ';
    $rrd_options .= " LINE1:acmCapacityMbps#00CC00:'ACM Total Capacity                 ' ";
    $rrd_options .= ' GPRINT:acmCapacityMbps:LAST:%0.2lf%s ';
    $rrd_options .= ' GPRINT:acmCapacityMbps:MIN:%0.2lf%s ';
    $rrd_options .= ' GPRINT:acmCapacityMbps:MAX:%0.2lf%s\\\l ';
