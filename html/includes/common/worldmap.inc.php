...
var greenMarker = L.AwesomeMarkers.icon({
    ...
    markerColor: \'green\', prefix: \'fa\', iconColor: \'white\'
        ...
        foreach (dbFetchRows($sql, $param) as $map_devices) {
            ...
            $temp_output .= "var title = '<a href=\"" . generate_device_url($map_devices) . "\"><img src=\"".getIcon($map_devices)."\" width=\"32\" height=\"32\" alt=\"\"> ".process_hostname($map_devices, $map_devices['hostname'])."</a>';
var tooltip = '".process_hostname($map_devices, $map_devices['hostname'])."';
