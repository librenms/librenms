...
$sql .= ' FROM `ports_fdb` AS F, `ports` AS P, `devices` AS D ';
...
$sql .= " WHERE F.port_id = P.port_id AND P.device_id = D.device_id $where ";
...
$sql = "SELECT *,`P`.`ifDescr` AS `interface`,`F`.`vlan_id` AS `vlan` $sql";
